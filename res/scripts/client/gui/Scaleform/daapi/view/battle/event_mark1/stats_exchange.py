...
class Mark1EventStatisticsDataController(ClassicStatisticsDataController):
    ...
    def _createExchangeBroker(self, exchangeCtx):
        ...
        exchangeBroker.setVehiclesInfoExchange(vehicle.VehiclesExchangeBlock(_Mark1VehicleInfoComponent(), positionComposer=broker.BiDirectionComposer(), idsComposers=(vehicle.TeamsSortedIDsComposer(), vehicle.TeamsCorrelationIDsComposer()), statsComposers=None))
