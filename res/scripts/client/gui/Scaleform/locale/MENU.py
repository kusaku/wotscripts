...
class MENU(object):
    ...
    MSGSTR_ = '#menu:msgstr'
    HANGAR_MARKPREVIEW_INFOBUTTON = '#menu:hangar/markPreview/infoButton'
    HANGAR_MARKPREVIEW_CREWBUTTON = '#menu:hangar/markPreview/crewButton'
    HANGAR_MARKPREVIEW_HEADERTITLE = '#menu:hangar/markPreview/headerTitle'
    HANGAR_MARKPREVIEW_HEADERDESC = '#menu:hangar/markPreview/headerDesc'
    HANGAR_MARKPREVIEW_MODULES = '#menu:hangar/markPreview/modules'
    HANGAR_MARKPREVIEW_DRAFTLINK = '#menu:hangar/markPreview/draftLink'
    HANGAR_MARKPREVIEW_CREWINFO = '#menu:hangar/markPreview/crewInfo'
    HANGAR_MARKPREVIEW_VEHICLEINFO = '#menu:hangar/markPreview/vehicleInfo'
    COPY = '#menu:copy'
    LEGAL = '#menu:legal'
