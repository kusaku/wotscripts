# Embedded file name: scripts/common/pydev/_pydevd_bundle/pydevd_breakpoints.py
...
class ExceptionBreakpoint:
    ...
    def __init__(self, qname, notify_always, notify_on_terminate, notify_on_first_raise_only, ignore_libraries):
...
def _excepthook(exctype, value, tb):
    ...
    if not exception_breakpoint:
        ...
        return
    elif exctype is KeyboardInterrupt:
        return
    else:
        frames = []
