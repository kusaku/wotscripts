# Embedded file name: scripts/common/pydev/_pydev_bundle/_pydev_jy_imports_tipper.py
import StringIO
import traceback
...
class Info:
    ...
    def __init__(self, name, **kwargs):
        ...
        self.varargs = kwargs.get('varargs', None)
    ...
    def basic_as_str(self):
        ...
        """
        s = 'function:%s args=%s, varargs=%s, kwargs=%s, docs:%s' % (str(self.name),
         str(self.args),
         str(self.varargs),
         str(self.kwargs),
         str(self.doc))
                ...
                if func.argslist[i]:
                    ...
                    for j in xrange(len(parameterTypes)):
                        ...
                        try:
                            ...
                            try:
                                paramClassName = repr(paramTypesClass)
...
if __name__ == '__main__':
    sys.path.append('D:\\dev_programs\\eclipse_3\\310\\eclipse\\plugins\\org.junit_3.8.1\\junit.jar')
