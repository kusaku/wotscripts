# Embedded file name: scripts/common/pydev/_pydev_runfiles/pydev_runfiles.py
...
class Configuration():
    ...
    def __init__(self, files_or_dirs = '', verbosity = 2, include_tests = None, tests = None, port = None, files_to_tests = None, jobs = 1, split_jobs = 'tests', coverage_output_dir = None, coverage_include = None, coverage_output_file = None, exclude_files = None, exclude_tests = None, include_files = None, django = False):
        ...
        self.django = django
        if not (include_tests and isinstance(include_tests, (list, tuple))):
            raise AssertionError
        if exclude_files:
            if not isinstance(exclude_files, (list, tuple)):
                raise AssertionError
            raise exclude_tests and (isinstance(exclude_tests, (list, tuple)) or AssertionError)
...
def parse_cmdline(argv = None):
    ...
    optlist, dirs = gnu_getopt(argv[1:], '', ['verbosity=',
     'tests=',
     'port=',
     'config_file=',
     'jobs=',
