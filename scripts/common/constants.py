...
if not sum([IS_CHINA, IS_KOREA, IS_SINGAPORE]) <= 1:
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        SORTIE_2 = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM_IN | RANSOM_OUT | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_SORTIE | DOSSIER_MAXSORTIE | DOSSIER_ACHIEVEMENTS_SORTIE | QUESTS | TKILL_RATING | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED | REPAIR_MECHANICS
        FORT_BATTLE_2 = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM_IN | RANSOM_OUT | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_FORT_BATTLE | DOSSIER_MAXFORTBATTLE | QUESTS | TKILL_RATING | DAILY_MULTIPLIED_XP | RENT_BATTLES_COUNTED | REPAIR_MECHANICS
