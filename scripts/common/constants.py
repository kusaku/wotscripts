...
if not sum([IS_CHINA, IS_KOREA, IS_SINGAPORE]) <= 1:
    ...
    ARENA_GAMEPLAY_NAMES = ('ctf', 'domination', 'assault', 'nations', 'ctf2', 'domination2', 'assault2', 'fallout', 'fallout2', 'fallout3', 'fallout4', 'ctf30x30', 'domination30x30', 'sandbox', 'bootcamp', 'leviathan')
    ...
    class ARENA_GUI_TYPE:
        ...
        RANGE = (UNKNOWN,
         ...
         EVENT_BATTLES_2)
        EVENT_RANGE = (EVENT_BATTLES, EVENT_BATTLES_2)
    ...
    class ARENA_GUI_TYPE_LABEL:
        LABELS = {ARENA_GUI_TYPE.UNKNOWN: 'special',
         ...
         ARENA_GUI_TYPE.EVENT_BATTLES_2: 'event2'}
    ...
    class PREBATTLE_TYPE:
        ...
        SQUAD_PREBATTLES = (SQUAD,
         ...
         EVENT,
         EVENT_2)
        EVENT_PREBATTLES = (EVENT, EVENT_2)
    ...
    EVENT_VEHICLE_TYPES = ('france:F80_FCM_F1_Mle1940_HE2017', 'france:F77_FCM_2C_HE2017')
    EVENT_VEHICLE_INDICES = dict(((x[1], x[0]) for x in enumerate(EVENT_VEHICLE_TYPES)))
    HALLOWEEN_BOSS_NAME = 'Leviathan'
    HALLOWEEN_BOSS_RAGE_HEALTH_RATIO = 0.3
    LEVIATHAN_HALFWAY_PROGRESS = 50
    LEVIATHAN_PROGRESS_CLOSE = 80
    ...
    class QUEUE_TYPE:
        ...
        BOOTCAMP = 18
        EVENT_BATTLES_2 = 19
        EVENT = (EVENT_BATTLES, EVENT_BATTLES_2)
...
class REQUEST_COOLDOWN:
    ...
    OPEN_HALLOWEEN_SUPPLY_DROP_COOLDOWN = 1.0
...
class REPAIR_FLAGS:
    ...
    PARTIAL_WITHOUT_RELOAD = STOP_FIRE | PARTIAL_HEAL_VEHICLE | HEAL_CREW | HEAL_DEVICES | REPLENISH_AMMO | REPLENISH_EQUIP
    ALL_HEAL_EFFECTS = STOP_FIRE | HEAL_VEHICLE | HEAL_CREW | HEAL_DEVICES
    PARTIAL_HEAL_EFFECTS = STOP_FIRE | PARTIAL_HEAL_VEHICLE | HEAL_CREW | HEAL_DEVICES
