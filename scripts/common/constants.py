...
if not sum([IS_CHINA, IS_KOREA, IS_SINGAPORE]) <= 1:
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        FIRST_APRIL = 2305843009213693952L
        ...
        EVENT_BATTLES = RESULTS | QUESTS | SQUADS | NO_ALLY_DAMAGE | FIRST_APRIL
    ...
    class ARENA_UPDATE:
        ...
        FIRST_APRIL_ACTION_SCHEDULED = 24
