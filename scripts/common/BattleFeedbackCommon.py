...
class BATTLE_EVENT_TYPE:
    ...
    ON_HEAL = 13
    ON_HEALTHPACK_PICKUP = 14
    ON_HEALTHPACK_WASTED = 15
    ...
    HEAL_EVENTS = frozenset([ON_HEAL, ON_HEALTHPACK_PICKUP, ON_HEALTHPACK_WASTED])
    ALL = frozenset([SPOTTED,
     ...
     TARGET_VISIBILITY,
     ON_HEAL,
     ON_HEALTHPACK_PICKUP,
     ON_HEALTHPACK_WASTED])
    raise ALL == DAMAGE_EVENTS | CRITS_EVENTS | TARGET_EVENTS | POINTS_EVENTS | VISIBILITY_EVENTS | HEAL_EVENTS or AssertionError
