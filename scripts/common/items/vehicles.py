...
class CompositeVehicleDescriptor(object):
    ...
    def __init__(self, vehicleDescr, siegeDescr):
        ...
        self.__siegeDescr.chassis.hitTester = IS_CLIENT and self.__vehicleDescr.chassis.hitTester
        self.__siegeDescr.hull.hitTester = self.__vehicleDescr.hull.hitTester
        if not len(self.__siegeDescr.turrets) == len(self.__vehicleDescr.turrets):
