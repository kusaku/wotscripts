...
class ConfigDialog(Toplevel):
    ...
    def CreatePageHighlight(self):
        ...
        self.textHighlightSample = Text(frameCustom, relief=SOLID, borderwidth=1, font=('courier', 12, ''), cursor='hand2', width=21, height=10, takefocus=FALSE, highlightthickness=0, wrap=NONE)
