...
class Parser:
    ...
    def find_good_parse_start--- This code section failed: ---
...
16	LOAD_FAST         'is_char_in_string'
19	POP_JUMP_IF_TRUE  '26'

22	LOAD_CONST        None
25	RETURN_END_IF     None
...
66	LOAD_CONST        0
69	LOAD_FAST         'limit'
72	CALL_FUNCTION_3   None
75	STORE_FAST        'i'

78	LOAD_FAST         'i'
81	LOAD_CONST        0
84	COMPARE_OP        '<'
87	POP_JUMP_IF_FALSE '94'
...
103	LOAD_CONST        0
106	LOAD_FAST         'i'
109	CALL_FUNCTION_3   None
112	LOAD_CONST        1
115	BINARY_ADD        None
116	STORE_FAST        'i'

119	LOAD_FAST         '_synchre'
122	LOAD_FAST         'str'
125	LOAD_FAST         'i'
128	LOAD_FAST         'limit'
...
137	LOAD_FAST         'm'
140	POP_JUMP_IF_FALSE '178'
143	LOAD_FAST         'is_char_in_string'
146	LOAD_FAST         'm'
149	LOAD_ATTR         'start'
...
158	UNARY_NOT         None
159_0	COME_FROM         '140'
159	POP_JUMP_IF_FALSE '178'

162	LOAD_FAST         'm'
165	LOAD_ATTR         'start'
168	CALL_FUNCTION_0   None
171	STORE_FAST        'pos'
...
191	LOAD_CONST        None
194	COMPARE_OP        'is'
197	POP_JUMP_IF_FALSE '256'

200	LOAD_FAST         '_synchre'
203	LOAD_FAST         'str'
206	CALL_FUNCTION_1   None
209	STORE_FAST        'm'

212	LOAD_FAST         'm'
215	POP_JUMP_IF_FALSE '252'
218	LOAD_FAST         'is_char_in_string'
221	LOAD_FAST         'm'
224	LOAD_ATTR         'start'
...
269	LOAD_FAST         '_synchre'
272	LOAD_FAST         'str'
275	LOAD_FAST         'i'
278	CALL_FUNCTION_2   None
281	STORE_FAST        'm'

284	LOAD_FAST         'm'
287	POP_JUMP_IF_FALSE '332'

290	LOAD_FAST         'm'
293	LOAD_ATTR         'span'
296	CALL_FUNCTION_0   None
299	UNPACK_SEQUENCE_2 None
302	STORE_FAST        's'
305	STORE_FAST        'i'

308	LOAD_FAST         'is_char_in_string'
311	LOAD_FAST         's'
314	CALL_FUNCTION_1   None
317	POP_JUMP_IF_TRUE  '333'

320	LOAD_FAST         's'
323	STORE_FAST        'pos'
326	JUMP_ABSOLUTE     '333'
329	JUMP_BACK         '269'
...
Syntax error at or near `POP_BLOCK' token at offset 336
