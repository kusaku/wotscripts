...
43	COMPARE_OP        'exception match'
46	POP_JUMP_IF_FALSE '74'
49	POP_TOP           None
50	POP_TOP           None
51	POP_TOP           None
...
90	LOAD_FAST         'self'
93	LOAD_ATTR         '_search_end'
96	CALL_FUNCTION_0   None
99	POP_TOP           None
...
112	DUP_TOP           None
113	LOAD_FAST         'self'
116	STORE_ATTR        'seekp'
119	STORE_FAST        'stop'

122	LOAD_FAST         'start'
125	LOAD_FAST         'stop'
128	COMPARE_OP        '!='
131	POP_JUMP_IF_FALSE '3'
...
142	LOAD_FAST         'self'
145	LOAD_ATTR         'factory'
148	LOAD_GLOBAL       '_PartialFile'
151	LOAD_FAST         'self'
154	LOAD_ATTR         'fp'
157	LOAD_FAST         'start'
160	LOAD_FAST         'stop'
163	CALL_FUNCTION_3   None
166	CALL_FUNCTION_1   None
...
class UnixMailbox(_Mailbox):
    ...
    def _search_start--- This code section failed: ---
...
18	LOAD_FAST         'self'
21	LOAD_ATTR         'fp'
24	LOAD_ATTR         'readline'
27	CALL_FUNCTION_0   None
30	STORE_FAST        'line'

33	LOAD_FAST         'line'
36	POP_JUMP_IF_TRUE  '48'

39	LOAD_GLOBAL       'EOFError'
42	RAISE_VARARGS_1   None
45	JUMP_FORWARD      '48'
48_0	COME_FROM         '45'
...
55	LOAD_CONST        'From '
58	COMPARE_OP        '=='
61	POP_JUMP_IF_FALSE '3'
64	LOAD_FAST         'self'
67	LOAD_ATTR         '_isrealfromline'
70	LOAD_FAST         'line'
73	CALL_FUNCTION_1   None
76_0	COME_FROM         '61'
76	POP_JUMP_IF_FALSE '3'
...
Syntax error at or near `POP_BLOCK' token at offset 102

    def _search_end--- This code section failed: ---
...
63	LOAD_CONST        'From '
66	COMPARE_OP        '=='
69	POP_JUMP_IF_FALSE '16'
72	LOAD_FAST         'self'
75	LOAD_ATTR         '_isrealfromline'
78	LOAD_FAST         'line'
81	CALL_FUNCTION_1   None
84_0	COME_FROM         '69'
84	POP_JUMP_IF_FALSE '16'
...
Syntax error at or near `POP_BLOCK' token at offset 110
...
18	LOAD_FAST         'line'
21	POP_JUMP_IF_TRUE  '33'

24	LOAD_GLOBAL       'EOFError'
27	RAISE_VARARGS_1   None
30	JUMP_FORWARD      '33'
33_0	COME_FROM         '30'
...
36	LOAD_CONST        5
39	SLICE+2           None
40	LOAD_CONST        '\x01\x01\x01\x01\n'
43	COMPARE_OP        '=='
46	POP_JUMP_IF_FALSE '3'
...
33	LOAD_FAST         'line'
36	POP_JUMP_IF_TRUE  '43'

39	LOAD_CONST        None
42	RETURN_END_IF     None

43	LOAD_FAST         'line'
46	LOAD_CONST        '\x01\x01\x01\x01\n'
49	COMPARE_OP        '=='
52	POP_JUMP_IF_FALSE '3'
...
Syntax error at or near `POP_BLOCK' token at offset 52
...
43	LOAD_FAST         'line'
46	LOAD_CONST        '\x1f\x0c\n'
49	COMPARE_OP        '=='
52	POP_JUMP_IF_TRUE  '67'
55	LOAD_FAST         'line'
58	LOAD_CONST        '\x1f'
61	COMPARE_OP        '=='
64_0	COME_FROM         '52'
64	POP_JUMP_IF_FALSE '3'
...
83	LOAD_CONST        None
86	RETURN_END_IF     None
87	JUMP_BACK         '3'
90	POP_BLOCK         None
91_0	COME_FROM         '0'

Syntax error at or near `POP_BLOCK' token at offset 90
