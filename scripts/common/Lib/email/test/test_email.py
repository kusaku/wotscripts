...
class TestNonConformant(TestEmailBase):
    ...
    def test_missing_start_boundary(self):
        ...
        self.assertTrue(isinstance(bad.defects[0], Errors.StartBoundaryNotFoundDefect))
    ...
    def test_first_line_is_continuation_header(self):
        ...
        self.assertTrue(isinstance(msg.defects[0], Errors.FirstHeaderLineIsContinuationDefect))
