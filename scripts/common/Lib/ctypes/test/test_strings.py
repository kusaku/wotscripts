...
class StringTestCase(unittest.TestCase):
    ...
    def XX_test_sized_strings(self):
        ...
        self.assertTrue(c_string(2).raw[-1] == '\x00')
    ...
    def XX_test_initialized_strings(self):
        ...
        self.assertTrue(c_string('ab', 4).raw[-1] == '\x00')
        self.assertTrue(c_string('ab', 2).raw == 'a\x00')
        return
...
try:
    ...
    class WStringTestCase(unittest.TestCase):
        ...
        def X_test_basic_wstrings(self):
            ...
            self.assertTrue(c_wstring(u'abc\x00def').value == u'abc')
            self.assertTrue(c_wstring(u'abc\x00def').value == u'abc')
            self.assertTrue(cs.raw == u'abcdef\x00')
            self.assertTrue(c_wstring(u'abc\x00def').raw == u'abc\x00def\x00')
            cs.value = u'ab'
            self.assertTrue(cs.value == u'ab')
            self.assertTrue(cs.raw == u'ab\x00\x00\x00\x00\x00')
