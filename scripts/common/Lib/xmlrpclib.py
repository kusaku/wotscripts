...
class Transport:
    ...
    def parse_response--- This code section failed: ---

0	LOAD_GLOBAL       'hasattr'
3	LOAD_FAST         'response'
6	LOAD_CONST        'getheader'
9	CALL_FUNCTION_2   None
12	POP_JUMP_IF_FALSE '63'

15	LOAD_FAST         'response'
18	LOAD_ATTR         'getheader'
21	LOAD_CONST        'Content-Encoding'
24	LOAD_CONST        ''
...
39	LOAD_GLOBAL       'GzipDecodedResponse'
42	LOAD_FAST         'response'
45	CALL_FUNCTION_1   None
48	STORE_FAST        'stream'
51	JUMP_ABSOLUTE     '69'

54	LOAD_FAST         'response'
57	STORE_FAST        'stream'
60	JUMP_FORWARD      '69'
...
69	LOAD_FAST         'self'
72	LOAD_ATTR         'getparser'
75	CALL_FUNCTION_0   None
78	UNPACK_SEQUENCE_2 None
81	STORE_FAST        'p'
84	STORE_FAST        'u'
...
105	LOAD_FAST         'data'
108	POP_JUMP_IF_TRUE  '115'

111	BREAK_LOOP        None
112	JUMP_FORWARD      '115'
115_0	COME_FROM         '112'

115	LOAD_FAST         'self'
118	LOAD_ATTR         'verbose'
...
137	PRINT_ITEM_CONT   None
138	PRINT_NEWLINE_CONT None
...
159	LOAD_FAST         'stream'
162	LOAD_FAST         'response'
165	COMPARE_OP        'is not'
168	POP_JUMP_IF_FALSE '184'

171	LOAD_FAST         'stream'
174	LOAD_ATTR         'close'
...
194	LOAD_FAST         'u'
197	LOAD_ATTR         'close'
200	CALL_FUNCTION_0   None
203	RETURN_VALUE      None
-1	RETURN_LAST       None

Syntax error at or near `POP_BLOCK' token at offset 158
