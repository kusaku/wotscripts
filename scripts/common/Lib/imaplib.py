...
9	LOAD_FAST         'name'
12	BINARY_SUBSCR     None
13	COMPARE_OP        'not in'
16	POP_JUMP_IF_FALSE '75'

19	LOAD_CONST        None
22	LOAD_FAST         'self'
25	STORE_ATTR        'literal'

28	LOAD_FAST         'self'
31	LOAD_ATTR         'error'
34	LOAD_CONST        'command %s illegal in state %s, only allowed in states %s'
...
46	LOAD_CONST        ', '
49	LOAD_ATTR         'join'
52	LOAD_GLOBAL       'Commands'
55	LOAD_FAST         'name'
58	BINARY_SUBSCR     None
59	CALL_FUNCTION_1   None
62	BUILD_TUPLE_3     None
65	BINARY_MODULO     None
66	CALL_FUNCTION_1   None
69	RAISE_VARARGS_1   None
72	JUMP_FORWARD      '75'
75_0	COME_FROM         '72'

75	SETUP_LOOP        '120'
78	LOAD_CONST        ('OK', 'NO', 'BAD')
81	GET_ITER          None
82	FOR_ITER          '119'
85	STORE_FAST        'typ'
...
88	LOAD_FAST         'typ'
91	LOAD_FAST         'self'
94	LOAD_ATTR         'untagged_responses'
97	COMPARE_OP        'in'
100	POP_JUMP_IF_FALSE '82'

103	LOAD_FAST         'self'
106	LOAD_ATTR         'untagged_responses'
109	LOAD_FAST         'typ'
112	DELETE_SUBSCR     None
113	JUMP_BACK         '82'
116	JUMP_BACK         '82'
119	POP_BLOCK         None
120_0	COME_FROM         '75'

120	LOAD_CONST        'READ-ONLY'
123	LOAD_FAST         'self'
126	LOAD_ATTR         'untagged_responses'
129	COMPARE_OP        'in'
132	POP_JUMP_IF_FALSE '163'

135	LOAD_FAST         'self'
138	LOAD_ATTR         'is_readonly'
141	UNARY_NOT         None
142_0	COME_FROM         '132'
142	POP_JUMP_IF_FALSE '163'

145	LOAD_FAST         'self'
148	LOAD_ATTR         'readonly'
151	LOAD_CONST        'mailbox status changed to READ-ONLY'
154	CALL_FUNCTION_1   None
157	RAISE_VARARGS_1   None
160	JUMP_FORWARD      '163'
163_0	COME_FROM         '160'

163	LOAD_FAST         'self'
166	LOAD_ATTR         '_new_tag'
...
251	LOAD_FAST         'self'
254	LOAD_ATTR         'literal'
257	STORE_FAST        'literal'

260	LOAD_FAST         'literal'
263	LOAD_CONST        None
266	COMPARE_OP        'is not'
269	POP_JUMP_IF_FALSE '348'

272	LOAD_CONST        None
275	LOAD_FAST         'self'
278	STORE_ATTR        'literal'

281	LOAD_GLOBAL       'type'
284	LOAD_FAST         'literal'
287	CALL_FUNCTION_1   None
290	LOAD_GLOBAL       'type'
293	LOAD_FAST         'self'
296	LOAD_ATTR         '_command'
299	CALL_FUNCTION_1   None
302	COMPARE_OP        'is'
305	POP_JUMP_IF_FALSE '317'

308	LOAD_FAST         'literal'
311	STORE_FAST        'literator'
314	JUMP_ABSOLUTE     '348'

317	LOAD_CONST        None
320	STORE_FAST        'literator'

323	LOAD_CONST        '%s {%s}'
326	LOAD_FAST         'data'
329	LOAD_GLOBAL       'len'
332	LOAD_FAST         'literal'
335	CALL_FUNCTION_1   None
338	BUILD_TUPLE_2     None
341	BINARY_MODULO     None
342	STORE_FAST        'data'
...
354	LOAD_CONST        4
357	COMPARE_OP        '>='
360	POP_JUMP_IF_FALSE '383'

363	LOAD_FAST         'self'
366	LOAD_ATTR         '_mesg'
369	LOAD_CONST        '> %s'
372	LOAD_FAST         'data'
375	BINARY_MODULO     None
376	CALL_FUNCTION_1   None
379	POP_TOP           None
380	JUMP_FORWARD      '400'

383	LOAD_FAST         'self'
386	LOAD_ATTR         '_log'
389	LOAD_CONST        '> %s'
392	LOAD_FAST         'data'
395	BINARY_MODULO     None
396	CALL_FUNCTION_1   None
399	POP_TOP           None
400_0	COME_FROM         '380'

400	SETUP_EXCEPT      '430'

403	LOAD_FAST         'self'
406	LOAD_ATTR         'send'
409	LOAD_CONST        '%s%s'
412	LOAD_FAST         'data'
415	LOAD_GLOBAL       'CRLF'
418	BUILD_TUPLE_2     None
421	BINARY_MODULO     None
422	CALL_FUNCTION_1   None
425	POP_TOP           None
426	POP_BLOCK         None
427	JUMP_FORWARD      '477'
430_0	COME_FROM         '400'

430	DUP_TOP           None
431	LOAD_GLOBAL       'socket'
434	LOAD_ATTR         'error'
437	LOAD_GLOBAL       'OSError'
440	BUILD_TUPLE_2     None
443	COMPARE_OP        'exception match'
446	POP_JUMP_IF_FALSE '476'
449	POP_TOP           None
450	STORE_FAST        'val'
453	POP_TOP           None
...
454	LOAD_FAST         'self'
457	LOAD_ATTR         'abort'
460	LOAD_CONST        'socket error: %s'
463	LOAD_FAST         'val'
466	BINARY_MODULO     None
467	CALL_FUNCTION_1   None
470	RAISE_VARARGS_1   None
473	JUMP_FORWARD      '477'
476	END_FINALLY       None
477_0	COME_FROM         '427'
477_1	COME_FROM         '476'

477	LOAD_FAST         'literal'
480	LOAD_CONST        None
483	COMPARE_OP        'is'
486	POP_JUMP_IF_FALSE '493'

489	LOAD_FAST         'tag'
492	RETURN_END_IF     None

493	SETUP_LOOP        '691'

496	SETUP_LOOP        '532'
499	LOAD_FAST         'self'
502	LOAD_ATTR         '_get_response'
505	CALL_FUNCTION_0   None
508	POP_JUMP_IF_FALSE '531'

511	LOAD_FAST         'self'
514	LOAD_ATTR         'tagged_commands'
517	LOAD_FAST         'tag'
520	BINARY_SUBSCR     None
521	POP_JUMP_IF_FALSE '499'

524	LOAD_FAST         'tag'
527	RETURN_END_IF     None
528	JUMP_BACK         '499'
531	POP_BLOCK         None
532_0	COME_FROM         '496'

532	LOAD_FAST         'literator'
535	POP_JUMP_IF_FALSE '556'

538	LOAD_FAST         'literator'
541	LOAD_FAST         'self'
544	LOAD_ATTR         'continuation_response'
547	CALL_FUNCTION_1   None
550	STORE_FAST        'literal'
...
562	LOAD_CONST        4
565	COMPARE_OP        '>='
568	POP_JUMP_IF_FALSE '597'

571	LOAD_FAST         'self'
574	LOAD_ATTR         '_mesg'
577	LOAD_CONST        'write literal size %s'
580	LOAD_GLOBAL       'len'
583	LOAD_FAST         'literal'
586	CALL_FUNCTION_1   None
589	BINARY_MODULO     None
590	CALL_FUNCTION_1   None
593	POP_TOP           None
594	JUMP_FORWARD      '597'
597_0	COME_FROM         '594'

597	SETUP_EXCEPT      '630'

600	LOAD_FAST         'self'
603	LOAD_ATTR         'send'
606	LOAD_FAST         'literal'
609	CALL_FUNCTION_1   None
612	POP_TOP           None

613	LOAD_FAST         'self'
616	LOAD_ATTR         'send'
619	LOAD_GLOBAL       'CRLF'
622	CALL_FUNCTION_1   None
625	POP_TOP           None
626	POP_BLOCK         None
627	JUMP_FORWARD      '677'
630_0	COME_FROM         '597'

630	DUP_TOP           None
631	LOAD_GLOBAL       'socket'
634	LOAD_ATTR         'error'
637	LOAD_GLOBAL       'OSError'
640	BUILD_TUPLE_2     None
643	COMPARE_OP        'exception match'
646	POP_JUMP_IF_FALSE '676'
649	POP_TOP           None
650	STORE_FAST        'val'
653	POP_TOP           None
...
654	LOAD_FAST         'self'
657	LOAD_ATTR         'abort'
660	LOAD_CONST        'socket error: %s'
663	LOAD_FAST         'val'
666	BINARY_MODULO     None
667	CALL_FUNCTION_1   None
670	RAISE_VARARGS_1   None
673	JUMP_FORWARD      '677'
676	END_FINALLY       None
677_0	COME_FROM         '627'
677_1	COME_FROM         '676'

677	LOAD_FAST         'literator'
680	POP_JUMP_IF_TRUE  '496'
...
691	LOAD_FAST         'tag'
694	RETURN_VALUE      None

Syntax error at or near `POP_BLOCK' token at offset 690
    ...
    def _get_tagged_response--- This code section failed: ---

0	SETUP_LOOP        '116'

3	LOAD_FAST         'self'
6	LOAD_ATTR         'tagged_commands'
9	LOAD_FAST         'tag'
12	BINARY_SUBSCR     None
13	STORE_FAST        'result'
...
28	LOAD_FAST         'self'
31	LOAD_ATTR         'tagged_commands'
34	LOAD_FAST         'tag'
37	DELETE_SUBSCR     None

38	LOAD_FAST         'result'
41	RETURN_END_IF     None

42	SETUP_EXCEPT      '59'

45	LOAD_FAST         'self'
48	LOAD_ATTR         '_get_response'
...
83	LOAD_CONST        1
86	COMPARE_OP        '>='
89	POP_JUMP_IF_FALSE '105'

92	LOAD_FAST         'self'
95	LOAD_ATTR         'print_log'
98	CALL_FUNCTION_0   None
101	POP_TOP           None
102	JUMP_FORWARD      '105'
105_0	COME_FROM         '102'

105	RAISE_VARARGS_0   None
108	JUMP_BACK         '3'
111	END_FINALLY       None
112_0	COME_FROM         '111'
112	JUMP_BACK         '3'
115	POP_BLOCK         None
116_0	COME_FROM         '0'
