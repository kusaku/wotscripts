...
class WidgetTest(unittest.TestCase):
    ...
    def test_identify(self):
        ...
        self.assertEqual(self.widget.identify(int(self.widget.winfo_width() / 2), int(self.widget.winfo_height() / 2)), 'label')
...
class TreeviewTest(unittest.TestCase):
    ...
    def test_insert_item(self):
        ...
        self.assertEqual(self.tv.item(item, values=None), ('a b c', '%s %s' % (value, value)))
