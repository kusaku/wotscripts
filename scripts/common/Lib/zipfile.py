...
9	LOAD_GLOBAL       'RuntimeError'

12	LOAD_CONST        'Attempt to write to ZIP archive that was already closed'
15	CALL_FUNCTION_1   None
18	RAISE_VARARGS_1   None
21	JUMP_FORWARD      '24'
24_0	COME_FROM         '21'
...
39	LOAD_GLOBAL       'stat'
42	LOAD_ATTR         'S_ISDIR'
45	LOAD_FAST         'st'
48	LOAD_ATTR         'st_mode'
51	CALL_FUNCTION_1   None
54	STORE_FAST        'isdir'

57	LOAD_GLOBAL       'time'
60	LOAD_ATTR         'localtime'
63	LOAD_FAST         'st'
66	LOAD_ATTR         'st_mtime'
...
81	LOAD_CONST        6
84	SLICE+3           None
85	STORE_FAST        'date_time'

88	LOAD_FAST         'arcname'
91	LOAD_CONST        None
94	COMPARE_OP        'is'
97	POP_JUMP_IF_FALSE '109'

100	LOAD_FAST         'filename'
103	STORE_FAST        'arcname'
106	JUMP_FORWARD      '109'
109_0	COME_FROM         '106'

109	LOAD_GLOBAL       'os'
112	LOAD_ATTR         'path'
115	LOAD_ATTR         'normpath'
118	LOAD_GLOBAL       'os'
121	LOAD_ATTR         'path'
124	LOAD_ATTR         'splitdrive'
127	LOAD_FAST         'arcname'
130	CALL_FUNCTION_1   None
133	LOAD_CONST        1
136	BINARY_SUBSCR     None
137	CALL_FUNCTION_1   None
140	STORE_FAST        'arcname'

143	SETUP_LOOP        '188'
146	LOAD_FAST         'arcname'
149	LOAD_CONST        0
152	BINARY_SUBSCR     None
153	LOAD_GLOBAL       'os'
156	LOAD_ATTR         'sep'
159	LOAD_GLOBAL       'os'
162	LOAD_ATTR         'altsep'
165	BUILD_TUPLE_2     None
168	COMPARE_OP        'in'
171	POP_JUMP_IF_FALSE '187'

174	LOAD_FAST         'arcname'
177	LOAD_CONST        1
180	SLICE+1           None
181	STORE_FAST        'arcname'
184	JUMP_BACK         '146'
187	POP_BLOCK         None
188_0	COME_FROM         '143'

188	LOAD_FAST         'isdir'
191	POP_JUMP_IF_FALSE '207'

194	LOAD_FAST         'arcname'
197	LOAD_CONST        '/'
200	INPLACE_ADD       None
201	STORE_FAST        'arcname'
204	JUMP_FORWARD      '207'
207_0	COME_FROM         '204'

207	LOAD_GLOBAL       'ZipInfo'
210	LOAD_FAST         'arcname'
213	LOAD_FAST         'date_time'
216	CALL_FUNCTION_2   None
219	STORE_FAST        'zinfo'

222	LOAD_FAST         'st'
225	LOAD_CONST        0
228	BINARY_SUBSCR     None
229	LOAD_CONST        65535
232	BINARY_AND        None
233	LOAD_CONST        16L
236	BINARY_LSHIFT     None
237	LOAD_FAST         'zinfo'
240	STORE_ATTR        'external_attr'

243	LOAD_FAST         'compress_type'
246	LOAD_CONST        None
249	COMPARE_OP        'is'
252	POP_JUMP_IF_FALSE '270'

255	LOAD_FAST         'self'
258	LOAD_ATTR         'compression'
261	LOAD_FAST         'zinfo'
264	STORE_ATTR        'compress_type'
267	JUMP_FORWARD      '279'

270	LOAD_FAST         'compress_type'
273	LOAD_FAST         'zinfo'
276	STORE_ATTR        'compress_type'
279_0	COME_FROM         '267'

279	LOAD_FAST         'st'
282	LOAD_ATTR         'st_size'
285	LOAD_FAST         'zinfo'
288	STORE_ATTR        'file_size'

291	LOAD_CONST        0
294	LOAD_FAST         'zinfo'
297	STORE_ATTR        'flag_bits'

300	LOAD_FAST         'self'
303	LOAD_ATTR         'fp'
306	LOAD_ATTR         'tell'
309	CALL_FUNCTION_0   None
312	LOAD_FAST         'zinfo'
315	STORE_ATTR        'header_offset'

318	LOAD_FAST         'self'
321	LOAD_ATTR         '_writecheck'
324	LOAD_FAST         'zinfo'
327	CALL_FUNCTION_1   None
330	POP_TOP           None

331	LOAD_GLOBAL       'True'
334	LOAD_FAST         'self'
337	STORE_ATTR        '_didModify'

340	LOAD_FAST         'isdir'
343	POP_JUMP_IF_FALSE '431'

346	LOAD_CONST        0
349	LOAD_FAST         'zinfo'
352	STORE_ATTR        'file_size'

355	LOAD_CONST        0
358	LOAD_FAST         'zinfo'
361	STORE_ATTR        'compress_size'
...
373	LOAD_FAST         'self'
376	LOAD_ATTR         'filelist'
379	LOAD_ATTR         'append'
382	LOAD_FAST         'zinfo'
385	CALL_FUNCTION_1   None
388	POP_TOP           None

389	LOAD_FAST         'zinfo'
392	LOAD_FAST         'self'
395	LOAD_ATTR         'NameToInfo'
398	LOAD_FAST         'zinfo'
401	LOAD_ATTR         'filename'
404	STORE_SUBSCR      None

405	LOAD_FAST         'self'
408	LOAD_ATTR         'fp'
411	LOAD_ATTR         'write'
414	LOAD_FAST         'zinfo'
417	LOAD_ATTR         'FileHeader'
420	CALL_FUNCTION_0   None
423	CALL_FUNCTION_1   None
426	POP_TOP           None

427	LOAD_CONST        None
430	RETURN_END_IF     None

431	LOAD_GLOBAL       'open'
434	LOAD_FAST         'filename'
437	LOAD_CONST        'rb'
440	CALL_FUNCTION_2   None
443	SETUP_WITH        '688'
446	STORE_FAST        'fp'
...
465	DUP_TOP           None
466	LOAD_FAST         'zinfo'
469	STORE_ATTR        'compress_size'
472	STORE_FAST        'compress_size'

475	LOAD_CONST        0
478	DUP_TOP           None
479	LOAD_FAST         'zinfo'
482	STORE_ATTR        'file_size'
485	STORE_FAST        'file_size'

488	LOAD_FAST         'self'
491	LOAD_ATTR         'fp'
494	LOAD_ATTR         'write'
497	LOAD_FAST         'zinfo'
500	LOAD_ATTR         'FileHeader'
503	CALL_FUNCTION_0   None
506	CALL_FUNCTION_1   None
509	POP_TOP           None

510	LOAD_FAST         'zinfo'
513	LOAD_ATTR         'compress_type'
516	LOAD_GLOBAL       'ZIP_DEFLATED'
519	COMPARE_OP        '=='
522	POP_JUMP_IF_FALSE '555'

525	LOAD_GLOBAL       'zlib'
528	LOAD_ATTR         'compressobj'
531	LOAD_GLOBAL       'zlib'
534	LOAD_ATTR         'Z_DEFAULT_COMPRESSION'

537	LOAD_GLOBAL       'zlib'
540	LOAD_ATTR         'DEFLATED'
543	LOAD_CONST        -15
546	CALL_FUNCTION_3   None
549	STORE_FAST        'cmpr'
552	JUMP_FORWARD      '561'
...
579	LOAD_FAST         'buf'
582	POP_JUMP_IF_TRUE  '589'

585	BREAK_LOOP        None
586	JUMP_FORWARD      '589'
589_0	COME_FROM         '586'

589	LOAD_FAST         'file_size'
592	LOAD_GLOBAL       'len'
595	LOAD_FAST         'buf'
598	CALL_FUNCTION_1   None
601	BINARY_ADD        None
602	STORE_FAST        'file_size'

605	LOAD_GLOBAL       'crc32'
608	LOAD_FAST         'buf'
611	LOAD_FAST         'CRC'
614	CALL_FUNCTION_2   None
617	LOAD_CONST        4294967295L
620	BINARY_AND        None
621	STORE_FAST        'CRC'

624	LOAD_FAST         'cmpr'
627	POP_JUMP_IF_FALSE '664'

630	LOAD_FAST         'cmpr'
633	LOAD_ATTR         'compress'
636	LOAD_FAST         'buf'
639	CALL_FUNCTION_1   None
642	STORE_FAST        'buf'

645	LOAD_FAST         'compress_size'
648	LOAD_GLOBAL       'len'
651	LOAD_FAST         'buf'
654	CALL_FUNCTION_1   None
657	BINARY_ADD        None
658	STORE_FAST        'compress_size'
661	JUMP_FORWARD      '664'
664_0	COME_FROM         '661'
...
685	LOAD_CONST        None
688_0	COME_FROM         '443'
688	WITH_CLEANUP      None
689	END_FINALLY       None

690	LOAD_FAST         'cmpr'
693	POP_JUMP_IF_FALSE '752'

696	LOAD_FAST         'cmpr'
699	LOAD_ATTR         'flush'
702	CALL_FUNCTION_0   None
705	STORE_FAST        'buf'

708	LOAD_FAST         'compress_size'
711	LOAD_GLOBAL       'len'
714	LOAD_FAST         'buf'
717	CALL_FUNCTION_1   None
720	BINARY_ADD        None
721	STORE_FAST        'compress_size'
...
740	LOAD_FAST         'compress_size'
743	LOAD_FAST         'zinfo'
746	STORE_ATTR        'compress_size'
749	JUMP_FORWARD      '761'

752	LOAD_FAST         'file_size'
755	LOAD_FAST         'zinfo'
758	STORE_ATTR        'compress_size'
761_0	COME_FROM         '749'
...
770	LOAD_FAST         'file_size'
773	LOAD_FAST         'zinfo'
776	STORE_ATTR        'file_size'

779	LOAD_FAST         'self'
782	LOAD_ATTR         'fp'
785	LOAD_ATTR         'tell'
788	CALL_FUNCTION_0   None
791	STORE_FAST        'position'

794	LOAD_FAST         'self'
797	LOAD_ATTR         'fp'
800	LOAD_ATTR         'seek'
803	LOAD_FAST         'zinfo'
806	LOAD_ATTR         'header_offset'
809	LOAD_CONST        14
812	BINARY_ADD        None
813	LOAD_CONST        0
816	CALL_FUNCTION_2   None
819	POP_TOP           None

820	LOAD_FAST         'self'
823	LOAD_ATTR         'fp'
826	LOAD_ATTR         'write'
829	LOAD_GLOBAL       'struct'
832	LOAD_ATTR         'pack'
835	LOAD_CONST        '<LLL'
838	LOAD_FAST         'zinfo'
841	LOAD_ATTR         'CRC'
844	LOAD_FAST         'zinfo'
847	LOAD_ATTR         'compress_size'

850	LOAD_FAST         'zinfo'
853	LOAD_ATTR         'file_size'
856	CALL_FUNCTION_4   None
...
866	LOAD_ATTR         'fp'
869	LOAD_ATTR         'seek'
872	LOAD_FAST         'position'
875	LOAD_CONST        0
878	CALL_FUNCTION_2   None
881	POP_TOP           None

882	LOAD_FAST         'self'
885	LOAD_ATTR         'filelist'
888	LOAD_ATTR         'append'
891	LOAD_FAST         'zinfo'
894	CALL_FUNCTION_1   None
897	POP_TOP           None

898	LOAD_FAST         'zinfo'
901	LOAD_FAST         'self'
904	LOAD_ATTR         'NameToInfo'
907	LOAD_FAST         'zinfo'
910	LOAD_ATTR         'filename'
913	STORE_SUBSCR      None
914	LOAD_CONST        None
917	RETURN_VALUE      None

Syntax error at or near `POP_BLOCK' token at offset 683
