...
class Folder():
    ...
    def getsequences--- This code section failed: ---

0	BUILD_MAP         None
3	STORE_FAST        'sequences'

6	LOAD_FAST         'self'
9	LOAD_ATTR         'getsequencesfilename'
12	CALL_FUNCTION_0   None
15	STORE_FAST        'fullname'
...
95	STORE_FAST        'fields'

98	LOAD_GLOBAL       'len'
101	LOAD_FAST         'fields'
104	CALL_FUNCTION_1   None
107	LOAD_CONST        2
110	COMPARE_OP        '!='
113	POP_JUMP_IF_FALSE '148'

116	LOAD_FAST         'self'
119	LOAD_ATTR         'error'
122	LOAD_CONST        'bad sequence in %s: %s'

125	LOAD_FAST         'fullname'
128	LOAD_FAST         'line'
131	LOAD_ATTR         'strip'
134	CALL_FUNCTION_0   None
137	BUILD_TUPLE_2     None
...
164	LOAD_GLOBAL       'IntSet'
167	LOAD_FAST         'fields'
170	LOAD_CONST        1
...
186	LOAD_ATTR         'tolist'
189	CALL_FUNCTION_0   None
192	STORE_FAST        'value'

195	LOAD_FAST         'value'
198	LOAD_FAST         'sequences'
201	LOAD_FAST         'key'
204	STORE_SUBSCR      None
205	JUMP_BACK         '61'
208	POP_BLOCK         None
209_0	COME_FROM         '58'

209	LOAD_FAST         'sequences'
...
Syntax error at or near `POP_BLOCK' token at offset 208
    ...
    def createmessage--- This code section failed: ---

0	LOAD_FAST         'self'
3	LOAD_ATTR         'getmessagefilename'
6	LOAD_FAST         'n'
9	CALL_FUNCTION_1   None
12	STORE_FAST        'path'

15	LOAD_FAST         'self'
18	LOAD_ATTR         'getmessagefilename'
21	LOAD_CONST        ',%d'
24	LOAD_FAST         'n'
27	BINARY_MODULO     None
28	CALL_FUNCTION_1   None
31	STORE_FAST        'backuppath'
...
83	LOAD_CONST        16384
86	STORE_FAST        'BUFSIZE'

89	SETUP_FINALLY     '172'
...
110	LOAD_FAST         'txt'
113	LOAD_ATTR         'read'
116	LOAD_FAST         'BUFSIZE'
119	CALL_FUNCTION_1   None
122	STORE_FAST        'buf'

125	LOAD_FAST         'buf'
128	POP_JUMP_IF_TRUE  '135'
...
172	LOAD_FAST         'ok'
175	POP_JUMP_IF_TRUE  '221'

178	SETUP_EXCEPT      '198'

181	LOAD_GLOBAL       'os'
184	LOAD_ATTR         'unlink'
187	LOAD_FAST         'path'
190	CALL_FUNCTION_1   None
193	POP_TOP           None
194	POP_BLOCK         None
195	JUMP_ABSOLUTE     '221'
198_0	COME_FROM         '178'
...
208	POP_JUMP_IF_FALSE '217'
211	POP_TOP           None
212	POP_TOP           None
213	POP_TOP           None

214	JUMP_ABSOLUTE     '221'
217	END_FINALLY       None
218_0	COME_FROM         '217'
218	JUMP_FORWARD      '221'
221_0	COME_FROM         '218'
221	END_FINALLY       None

Syntax error at or near `POP_BLOCK' token at offset 151
...
def pickline--- This code section failed: ---
...
22	DUP_TOP           None
23	LOAD_GLOBAL       'IOError'
26	COMPARE_OP        'exception match'
29	POP_JUMP_IF_FALSE '39'
32	POP_TOP           None
33	POP_TOP           None
34	POP_TOP           None
...
59	LOAD_GLOBAL       're'
62	LOAD_ATTR         'compile'
65	LOAD_FAST         'pat'
68	LOAD_FAST         'casefold'
71	JUMP_IF_FALSE_OR_POP '80'
74	LOAD_GLOBAL       're'
77	LOAD_ATTR         'IGNORECASE'
80_0	COME_FROM         '71'
80	CALL_FUNCTION_2   None
83	STORE_FAST        'prog'
...
149	LOAD_FAST         'f'
152	LOAD_ATTR         'readline'
155	CALL_FUNCTION_0   None
158	STORE_FAST        'line'

161	LOAD_FAST         'line'
164	UNARY_NOT         None
165	POP_JUMP_IF_TRUE  '185'
168	LOAD_FAST         'line'
171	LOAD_CONST        0
174	BINARY_SUBSCR     None
175	LOAD_ATTR         'isspace'
178	CALL_FUNCTION_0   None
181	UNARY_NOT         None
182_0	COME_FROM         '165'
182	POP_JUMP_IF_FALSE '189'
