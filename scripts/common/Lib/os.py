...
105	LOAD_GLOBAL       'waitpid'
108	LOAD_FAST         'pid'
111	LOAD_CONST        0
114	CALL_FUNCTION_2   None
117	UNPACK_SEQUENCE_2 None
120	STORE_FAST        'wpid'
123	STORE_FAST        'sts'

126	LOAD_GLOBAL       'WIFSTOPPED'
129	LOAD_FAST         'sts'
132	CALL_FUNCTION_1   None
135	POP_JUMP_IF_FALSE '144'

138	CONTINUE          '105'
141	JUMP_BACK         '105'

144	LOAD_GLOBAL       'WIFSIGNALED'
147	LOAD_FAST         'sts'
150	CALL_FUNCTION_1   None
153	POP_JUMP_IF_FALSE '167'

156	LOAD_GLOBAL       'WTERMSIG'
159	LOAD_FAST         'sts'
162	CALL_FUNCTION_1   None
165	UNARY_NEGATIVE    None
166	RETURN_END_IF     None

167	LOAD_GLOBAL       'WIFEXITED'
170	LOAD_FAST         'sts'
173	CALL_FUNCTION_1   None
176	POP_JUMP_IF_FALSE '189'

179	LOAD_GLOBAL       'WEXITSTATUS'
182	LOAD_FAST         'sts'
185	CALL_FUNCTION_1   None
188	RETURN_END_IF     None

189	LOAD_GLOBAL       'error'
192	LOAD_CONST        'Not stopped, signaled or exited???'
...
Syntax error at or near `POP_BLOCK' token at offset 201
