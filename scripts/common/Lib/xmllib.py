...
class XMLParser():
    ...
    def translate_references--- This code section failed: ---

0	LOAD_FAST         'self'
3	LOAD_ATTR         '__translate_attribute_references'
...
101	LOAD_FAST         'self'
104	LOAD_ATTR         'syntax_error'
107	LOAD_CONST        "bogus `&'"
...
251	LOAD_FAST         'i'
254	LOAD_CONST        1
257	BINARY_SUBTRACT   None
258	BINARY_SUBSCR     None
259	LOAD_CONST        ';'
262	COMPARE_OP        '!='
265	POP_JUMP_IF_FALSE '472'

268	LOAD_FAST         'self'
271	LOAD_ATTR         'syntax_error'
274	LOAD_CONST        "`;' missing after char reference"
277	CALL_FUNCTION_1   None
280	POP_TOP           None

281	LOAD_FAST         'i'
284	LOAD_CONST        1
287	BINARY_SUBTRACT   None
288	STORE_FAST        'i'
291	JUMP_ABSOLUTE     '472'
294	JUMP_FORWARD      '472'

297	LOAD_FAST         'all'
300	POP_JUMP_IF_FALSE '423'

303	LOAD_FAST         'str'
306	LOAD_FAST         'self'
309	LOAD_ATTR         'entitydefs'
312	COMPARE_OP        'in'
315	POP_JUMP_IF_FALSE '340'

318	LOAD_FAST         'self'
321	LOAD_ATTR         'entitydefs'
324	LOAD_FAST         'str'
327	BINARY_SUBSCR     None
328	STORE_FAST        'str'

331	LOAD_CONST        1
334	STORE_FAST        'rescan'
337	JUMP_ABSOLUTE     '472'
...
351	LOAD_CONST        ';'
354	COMPARE_OP        '!='
357	POP_JUMP_IF_FALSE '389'

360	LOAD_FAST         'self'
363	LOAD_ATTR         'syntax_error'
366	LOAD_CONST        "bogus `&'"
369	CALL_FUNCTION_1   None
372	POP_TOP           None
...
383	CONTINUE          '22'
386	JUMP_ABSOLUTE     '472'

389	LOAD_FAST         'self'
392	LOAD_ATTR         'syntax_error'
395	LOAD_CONST        "reference to unknown entity `&%s;'"
398	LOAD_FAST         'str'
401	BINARY_MODULO     None
...
416	BINARY_ADD        None
417	STORE_FAST        'str'
420	JUMP_FORWARD      '472'

423	LOAD_FAST         'data'
426	LOAD_FAST         'i'
429	LOAD_CONST        1
432	BINARY_SUBTRACT   None
433	BINARY_SUBSCR     None
434	LOAD_CONST        ';'
437	COMPARE_OP        '!='
440	POP_JUMP_IF_FALSE '472'

443	LOAD_FAST         'self'
446	LOAD_ATTR         'syntax_error'
449	LOAD_CONST        "bogus `&'"
...
494	LOAD_FAST         'rescan'
497	POP_JUMP_IF_FALSE '509'
...
Syntax error at or near `POP_BLOCK' token at offset 528
