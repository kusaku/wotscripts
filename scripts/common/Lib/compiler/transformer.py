...
class Transformer():
    ...
    def com_assign--- This code section failed: ---
...
13	LOAD_FAST         't'
16	LOAD_GLOBAL       'symbol'
19	LOAD_ATTR         'exprlist'
22	LOAD_GLOBAL       'symbol'
25	LOAD_ATTR         'testlist'
28	LOAD_GLOBAL       'symbol'
31	LOAD_ATTR         'testlist_safe'
34	LOAD_GLOBAL       'symbol'
37	LOAD_ATTR         'testlist_comp'
40	BUILD_TUPLE_4     None
43	COMPARE_OP        'in'
46	POP_JUMP_IF_FALSE '96'
...
67	LOAD_FAST         'self'
70	LOAD_ATTR         'com_assign_tuple'
73	LOAD_FAST         'node'
76	LOAD_FAST         'assigning'
79	CALL_FUNCTION_2   None
82	RETURN_END_IF     None
...
96	LOAD_FAST         't'
99	LOAD_GLOBAL       '_assign_types'
102	COMPARE_OP        'in'
105	POP_JUMP_IF_FALSE '151'
...
117	LOAD_CONST        2
120	COMPARE_OP        '>'
123	POP_JUMP_IF_FALSE '138'

126	LOAD_GLOBAL       'SyntaxError'
129	LOAD_CONST        "can't assign to operator"
132	RAISE_VARARGS_2   None
...
151	LOAD_FAST         't'
154	LOAD_GLOBAL       'symbol'
157	LOAD_ATTR         'power'
160	COMPARE_OP        '=='
163	POP_JUMP_IF_FALSE '369'
...
177	LOAD_GLOBAL       'symbol'
180	LOAD_ATTR         'atom'
183	COMPARE_OP        '!='
186	POP_JUMP_IF_FALSE '201'

189	LOAD_GLOBAL       'SyntaxError'
192	LOAD_CONST        "can't assign to operator"
195	RAISE_VARARGS_2   None
198	JUMP_FORWARD      '201'
201_0	COME_FROM         '198'
...
210	LOAD_CONST        2
213	COMPARE_OP        '>'
216	POP_JUMP_IF_FALSE '356'

219	LOAD_FAST         'self'
222	LOAD_ATTR         'com_node'
225	LOAD_FAST         'node'
228	LOAD_CONST        1
231	BINARY_SUBSCR     None
232	CALL_FUNCTION_1   None
235	STORE_FAST        'primary'

238	SETUP_LOOP        '333'
241	LOAD_GLOBAL       'range'
244	LOAD_CONST        2
247	LOAD_GLOBAL       'len'
250	LOAD_FAST         'node'
...
287	LOAD_GLOBAL       'token'
290	LOAD_ATTR         'DOUBLESTAR'
293	COMPARE_OP        '=='
296	POP_JUMP_IF_FALSE '311'

299	LOAD_GLOBAL       'SyntaxError'
302	LOAD_CONST        "can't assign to operator"
305	RAISE_VARARGS_2   None
308	JUMP_FORWARD      '311'
311_0	COME_FROM         '308'

311	LOAD_FAST         'self'
314	LOAD_ATTR         'com_apply_trailer'
317	LOAD_FAST         'primary'
320	LOAD_FAST         'ch'
323	CALL_FUNCTION_2   None
326	STORE_FAST        'primary'
329	JUMP_BACK         '264'
332	POP_BLOCK         None
333_0	COME_FROM         '238'

333	LOAD_FAST         'self'
336	LOAD_ATTR         'com_assign_trailer'
339	LOAD_FAST         'primary'
342	LOAD_FAST         'node'
345	LOAD_CONST        -1
348	BINARY_SUBSCR     None

349	LOAD_FAST         'assigning'
352	CALL_FUNCTION_3   None
355	RETURN_END_IF     None

356	LOAD_FAST         'node'
359	LOAD_CONST        1
362	BINARY_SUBSCR     None
363	STORE_FAST        'node'
366	JUMP_BACK         '3'

369	LOAD_FAST         't'
372	LOAD_GLOBAL       'symbol'
375	LOAD_ATTR         'atom'
378	COMPARE_OP        '=='
381	POP_JUMP_IF_FALSE '576'

384	LOAD_FAST         'node'
387	LOAD_CONST        1
390	BINARY_SUBSCR     None
391	LOAD_CONST        0
394	BINARY_SUBSCR     None
395	STORE_FAST        't'

398	LOAD_FAST         't'
401	LOAD_GLOBAL       'token'
404	LOAD_ATTR         'LPAR'
407	COMPARE_OP        '=='
410	POP_JUMP_IF_FALSE '457'
...
423	LOAD_FAST         'node'
426	LOAD_CONST        0
429	BINARY_SUBSCR     None
430	LOAD_GLOBAL       'token'
433	LOAD_ATTR         'RPAR'
436	COMPARE_OP        '=='
439	POP_JUMP_IF_FALSE '573'

442	LOAD_GLOBAL       'SyntaxError'
445	LOAD_CONST        "can't assign to ()"
448	RAISE_VARARGS_2   None
451	JUMP_ABSOLUTE     '573'
454	JUMP_ABSOLUTE     '589'

457	LOAD_FAST         't'
460	LOAD_GLOBAL       'token'
463	LOAD_ATTR         'LSQB'
466	COMPARE_OP        '=='
469	POP_JUMP_IF_FALSE '529'
...
482	LOAD_FAST         'node'
485	LOAD_CONST        0
488	BINARY_SUBSCR     None
489	LOAD_GLOBAL       'token'
492	LOAD_ATTR         'RSQB'
495	COMPARE_OP        '=='
498	POP_JUMP_IF_FALSE '513'

501	LOAD_GLOBAL       'SyntaxError'
504	LOAD_CONST        "can't assign to []"
507	RAISE_VARARGS_2   None
510	JUMP_FORWARD      '513'
513_0	COME_FROM         '510'

513	LOAD_FAST         'self'
516	LOAD_ATTR         'com_assign_list'
519	LOAD_FAST         'node'
522	LOAD_FAST         'assigning'
525	CALL_FUNCTION_2   None
528	RETURN_END_IF     None

529	LOAD_FAST         't'
532	LOAD_GLOBAL       'token'
535	LOAD_ATTR         'NAME'
538	COMPARE_OP        '=='
541	POP_JUMP_IF_FALSE '564'

544	LOAD_FAST         'self'
547	LOAD_ATTR         'com_assign_name'
550	LOAD_FAST         'node'
553	LOAD_CONST        1
556	BINARY_SUBSCR     None
557	LOAD_FAST         'assigning'
560	CALL_FUNCTION_2   None
563	RETURN_END_IF     None

564	LOAD_GLOBAL       'SyntaxError'
567	LOAD_CONST        "can't assign to literal"
570	RAISE_VARARGS_2   None
573	JUMP_BACK         '3'

576	LOAD_GLOBAL       'SyntaxError'
579	LOAD_CONST        'bad assignment (%s)'
582	LOAD_FAST         't'
585	BINARY_MODULO     None
586	RAISE_VARARGS_2   None
589	JUMP_BACK         '3'
592	POP_BLOCK         None
593_0	COME_FROM         '0'

Syntax error at or near `POP_BLOCK' token at offset 592
