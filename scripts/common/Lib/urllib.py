...
0	LOAD_GLOBAL       'unwrap'
3	LOAD_GLOBAL       'toBytes'
6	LOAD_FAST         'url'
...
18	LOAD_FAST         'self'
21	LOAD_ATTR         'tempcache'
24	POP_JUMP_IF_FALSE '53'
27	LOAD_FAST         'url'
30	LOAD_FAST         'self'
33	LOAD_ATTR         'tempcache'
36	COMPARE_OP        'in'
39_0	COME_FROM         '24'
39	POP_JUMP_IF_FALSE '53'

42	LOAD_FAST         'self'
45	LOAD_ATTR         'tempcache'
48	LOAD_FAST         'url'
51	BINARY_SUBSCR     None
52	RETURN_END_IF     None

53	LOAD_GLOBAL       'splittype'
56	LOAD_FAST         'url'
59	CALL_FUNCTION_1   None
62	UNPACK_SEQUENCE_2 None
65	STORE_FAST        'type'
68	STORE_FAST        'url1'

71	LOAD_FAST         'filename'
74	LOAD_CONST        None
77	COMPARE_OP        'is'
80	POP_JUMP_IF_FALSE '192'
83	LOAD_FAST         'type'
86	UNARY_NOT         None
87	POP_JUMP_IF_TRUE  '102'
90	LOAD_FAST         'type'
93	LOAD_CONST        'file'
96	COMPARE_OP        '=='
99_0	COME_FROM         '80'
99_1	COME_FROM         '87'
99	POP_JUMP_IF_FALSE '192'

102	SETUP_EXCEPT      '172'

105	LOAD_FAST         'self'
108	LOAD_ATTR         'open_local_file'
111	LOAD_FAST         'url1'
...
142	LOAD_GLOBAL       'url2pathname'
145	LOAD_GLOBAL       'splithost'
148	LOAD_FAST         'url1'
151	CALL_FUNCTION_1   None
154	LOAD_CONST        1
157	BINARY_SUBSCR     None
158	CALL_FUNCTION_1   None
161	LOAD_FAST         'hdrs'
164	BUILD_TUPLE_2     None
167	RETURN_VALUE      None
168	POP_BLOCK         None
169	JUMP_ABSOLUTE     '192'
172_0	COME_FROM         '102'

172	DUP_TOP           None
173	LOAD_GLOBAL       'IOError'
176	COMPARE_OP        'exception match'
179	POP_JUMP_IF_FALSE '188'
182	POP_TOP           None
183	POP_TOP           None
184	POP_TOP           None

185	JUMP_ABSOLUTE     '192'
188	END_FINALLY       None
189_0	COME_FROM         '188'
...
210	SETUP_FINALLY     '675'

213	LOAD_FAST         'fp'
216	LOAD_ATTR         'info'
219	CALL_FUNCTION_0   None
222	STORE_FAST        'headers'

225	LOAD_FAST         'filename'
228	POP_JUMP_IF_FALSE '249'

231	LOAD_GLOBAL       'open'
234	LOAD_FAST         'filename'
237	LOAD_CONST        'wb'
240	CALL_FUNCTION_2   None
243	STORE_FAST        'tfp'
246	JUMP_FORWARD      '428'

249	LOAD_CONST        -1
252	LOAD_CONST        None
255	IMPORT_NAME       'tempfile'
258	STORE_FAST        'tempfile'

261	LOAD_GLOBAL       'splittype'
264	LOAD_FAST         'url'
267	CALL_FUNCTION_1   None
270	UNPACK_SEQUENCE_2 None
273	STORE_FAST        'garbage'
276	STORE_FAST        'path'

279	LOAD_GLOBAL       'splithost'
282	LOAD_FAST         'path'
285	JUMP_IF_TRUE_OR_POP '291'
288	LOAD_CONST        ''
291_0	COME_FROM         '285'
291	CALL_FUNCTION_1   None
294	UNPACK_SEQUENCE_2 None
297	STORE_FAST        'garbage'
300	STORE_FAST        'path'

303	LOAD_GLOBAL       'splitquery'
306	LOAD_FAST         'path'
309	JUMP_IF_TRUE_OR_POP '315'
312	LOAD_CONST        ''
315_0	COME_FROM         '309'
315	CALL_FUNCTION_1   None
318	UNPACK_SEQUENCE_2 None
321	STORE_FAST        'path'
324	STORE_FAST        'garbage'

327	LOAD_GLOBAL       'splitattr'
330	LOAD_FAST         'path'
333	JUMP_IF_TRUE_OR_POP '339'
336	LOAD_CONST        ''
339_0	COME_FROM         '333'
339	CALL_FUNCTION_1   None
342	UNPACK_SEQUENCE_2 None
345	STORE_FAST        'path'
348	STORE_FAST        'garbage'

351	LOAD_GLOBAL       'os'
354	LOAD_ATTR         'path'
357	LOAD_ATTR         'splitext'
360	LOAD_FAST         'path'
363	CALL_FUNCTION_1   None
366	LOAD_CONST        1
369	BINARY_SUBSCR     None
370	STORE_FAST        'suffix'

373	LOAD_FAST         'tempfile'
376	LOAD_ATTR         'mkstemp'
379	LOAD_FAST         'suffix'
382	CALL_FUNCTION_1   None
385	UNPACK_SEQUENCE_2 None
388	STORE_FAST        'fd'
391	STORE_FAST        'filename'

394	LOAD_FAST         'self'
397	LOAD_ATTR         '__tempfiles'
400	LOAD_ATTR         'append'
403	LOAD_FAST         'filename'
406	CALL_FUNCTION_1   None
409	POP_TOP           None

410	LOAD_GLOBAL       'os'
413	LOAD_ATTR         'fdopen'
416	LOAD_FAST         'fd'
419	LOAD_CONST        'wb'
422	CALL_FUNCTION_2   None
425	STORE_FAST        'tfp'
428_0	COME_FROM         '246'

428	SETUP_FINALLY     '660'

431	LOAD_FAST         'filename'
434	LOAD_FAST         'headers'
437	BUILD_TUPLE_2     None
440	STORE_FAST        'result'

443	LOAD_FAST         'self'
446	LOAD_ATTR         'tempcache'
449	LOAD_CONST        None
452	COMPARE_OP        'is not'
455	POP_JUMP_IF_FALSE '474'

458	LOAD_FAST         'result'
461	LOAD_FAST         'self'
464	LOAD_ATTR         'tempcache'
467	LOAD_FAST         'url'
470	STORE_SUBSCR      None
...
492	LOAD_CONST        0
495	STORE_FAST        'blocknum'

498	LOAD_CONST        'content-length'
501	LOAD_FAST         'headers'
504	COMPARE_OP        'in'
507	POP_JUMP_IF_FALSE '529'

510	LOAD_GLOBAL       'int'
513	LOAD_FAST         'headers'
516	LOAD_CONST        'Content-Length'
519	BINARY_SUBSCR     None
520	CALL_FUNCTION_1   None
523	STORE_FAST        'size'
526	JUMP_FORWARD      '529'
529_0	COME_FROM         '526'

529	LOAD_FAST         'reporthook'
532	POP_JUMP_IF_FALSE '554'

535	LOAD_FAST         'reporthook'
538	LOAD_FAST         'blocknum'
541	LOAD_FAST         'bs'
544	LOAD_FAST         'size'
547	CALL_FUNCTION_3   None
550	POP_TOP           None
551	JUMP_FORWARD      '554'
554_0	COME_FROM         '551'
...
569	STORE_FAST        'block'

572	LOAD_FAST         'block'
575	LOAD_CONST        ''
578	COMPARE_OP        '=='
581	POP_JUMP_IF_FALSE '588'
...
617	LOAD_FAST         'blocknum'
620	LOAD_CONST        1
623	INPLACE_ADD       None
624	STORE_FAST        'blocknum'

627	LOAD_FAST         'reporthook'
630	POP_JUMP_IF_FALSE '557'

633	LOAD_FAST         'reporthook'
636	LOAD_FAST         'blocknum'
639	LOAD_FAST         'bs'
642	LOAD_FAST         'size'
645	CALL_FUNCTION_3   None
648	POP_TOP           None
649	JUMP_BACK         '557'
652	JUMP_BACK         '557'
655	POP_BLOCK         None
...
675	LOAD_FAST         'fp'
678	LOAD_ATTR         'close'
681	CALL_FUNCTION_0   None
684	POP_TOP           None
685	END_FINALLY       None

686	LOAD_FAST         'size'
689	LOAD_CONST        0
692	COMPARE_OP        '>='
695	POP_JUMP_IF_FALSE '738'
698	LOAD_FAST         'read'
701	LOAD_FAST         'size'
704	COMPARE_OP        '<'
707_0	COME_FROM         '695'
707	POP_JUMP_IF_FALSE '738'

710	LOAD_GLOBAL       'ContentTooShortError'
713	LOAD_CONST        'retrieval incomplete: got only %i out of %i bytes'

716	LOAD_FAST         'read'
719	LOAD_FAST         'size'
722	BUILD_TUPLE_2     None
725	BINARY_MODULO     None
726	LOAD_FAST         'result'
729	CALL_FUNCTION_2   None
732	RAISE_VARARGS_1   None
735	JUMP_FORWARD      '738'
738_0	COME_FROM         '735'

738	LOAD_FAST         'result'
