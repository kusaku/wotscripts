...
def _cmd--- This code section failed: ---

0	LOAD_CONST        'cd "%s"; '
3	LOAD_FAST         'dir'
6	BINARY_MODULO     None
7	LOAD_CONST        ' '
10	LOAD_ATTR         'join'
13	LOAD_FAST         'cmditems'
16	CALL_FUNCTION_1   None
19	BINARY_ADD        None
20	STORE_FAST        'cmd'

23	LOAD_FAST         'output'
26	POP_JUMP_IF_FALSE '49'

29	LOAD_FAST         'output'
32	LOAD_ATTR         'write'
35	LOAD_CONST        '+ %s\n'
38	LOAD_FAST         'cmd'
41	BINARY_MODULO     None
42	CALL_FUNCTION_1   None
45	POP_TOP           None
46	JUMP_FORWARD      '49'
49_0	COME_FROM         '46'

49	LOAD_GLOBAL       'NO_EXECUTE'
52	POP_JUMP_IF_FALSE '59'

55	LOAD_CONST        0
58	RETURN_END_IF     None

59	LOAD_GLOBAL       'subprocess'
62	LOAD_ATTR         'Popen'
65	LOAD_FAST         'cmd'
68	LOAD_CONST        'shell'
71	LOAD_GLOBAL       'True'
74	LOAD_CONST        'stdin'
77	LOAD_GLOBAL       'subprocess'
80	LOAD_ATTR         'PIPE'
83	LOAD_CONST        'stdout'

86	LOAD_GLOBAL       'subprocess'
89	LOAD_ATTR         'PIPE'
92	LOAD_CONST        'stderr'
95	LOAD_GLOBAL       'subprocess'
98	LOAD_ATTR         'STDOUT'
101	CALL_FUNCTION_1025 None
104	STORE_FAST        'child'
...
123	LOAD_FAST         'child'
126	LOAD_ATTR         'stdout'
129	LOAD_ATTR         'readline'
132	CALL_FUNCTION_0   None
135	STORE_FAST        'line'

138	LOAD_FAST         'line'
141	POP_JUMP_IF_TRUE  '148'

144	BREAK_LOOP        None
145	JUMP_FORWARD      '148'
148_0	COME_FROM         '145'

148	LOAD_FAST         'output'
151	POP_JUMP_IF_FALSE '123'

154	LOAD_FAST         'output'
157	LOAD_ATTR         'write'
160	LOAD_FAST         'line'
