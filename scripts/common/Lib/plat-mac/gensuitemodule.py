...
class ObjectCompiler():
    ...
    def findcodename--- This code section failed: ---

0	SETUP_LOOP        '275'

3	SETUP_LOOP        '57'
6	LOAD_FAST         'self'
9	LOAD_ATTR         'namemappers'
12	GET_ITER          None
13	FOR_ITER          '56'
16	STORE_FAST        'mapper'

19	LOAD_FAST         'mapper'
22	LOAD_ATTR         'hascode'
25	LOAD_FAST         'type'
28	LOAD_FAST         'code'
31	CALL_FUNCTION_2   None
34	POP_JUMP_IF_FALSE '13'

37	LOAD_FAST         'mapper'
40	LOAD_ATTR         'findcodename'
43	LOAD_FAST         'type'
46	LOAD_FAST         'code'
...
57	SETUP_LOOP        '271'
60	LOAD_FAST         'self'
63	LOAD_ATTR         'othernamemappers'
66	GET_ITER          None
67	FOR_ITER          '165'
70	STORE_FAST        'mapper'

73	LOAD_FAST         'mapper'
76	LOAD_ATTR         'hascode'
79	LOAD_FAST         'type'
82	LOAD_FAST         'code'
85	CALL_FUNCTION_2   None
88	POP_JUMP_IF_FALSE '67'

91	LOAD_FAST         'self'
94	LOAD_ATTR         'othernamemappers'
97	LOAD_ATTR         'remove'
100	LOAD_FAST         'mapper'
103	CALL_FUNCTION_1   None
106	POP_TOP           None

107	LOAD_FAST         'self'
110	LOAD_ATTR         'namemappers'
113	LOAD_ATTR         'append'
116	LOAD_FAST         'mapper'
119	CALL_FUNCTION_1   None
122	POP_TOP           None

123	LOAD_FAST         'self'
126	LOAD_ATTR         'fp'
129	POP_JUMP_IF_FALSE '158'

132	LOAD_FAST         'self'
135	LOAD_ATTR         'fp'
138	LOAD_ATTR         'write'
141	LOAD_CONST        'import %s\n'
144	LOAD_FAST         'mapper'
147	LOAD_ATTR         'modulename'
150	BINARY_MODULO     None
...
175	LOAD_FAST         'self'
178	LOAD_ATTR         'askdefinitionmodule'
181	LOAD_FAST         'type'
184	LOAD_FAST         'code'
187	CALL_FUNCTION_2   None
190	STORE_FAST        'm'
193	JUMP_FORWARD      '202'
...
202	LOAD_FAST         'm'
205	POP_JUMP_IF_TRUE  '212'
208	LOAD_CONST        (None, None, None)
211	RETURN_END_IF     None

212	LOAD_GLOBAL       'CodeNameMapper'
215	LOAD_FAST         'self'
218	LOAD_ATTR         'can_interact'
221	LOAD_FAST         'self'
224	LOAD_ATTR         'verbose'
227	CALL_FUNCTION_2   None
230	STORE_FAST        'mapper'

233	LOAD_FAST         'mapper'
236	LOAD_ATTR         'addmodule'
239	LOAD_FAST         'm'
242	LOAD_FAST         'm'
245	LOAD_ATTR         '__name__'
248	LOAD_CONST        0
251	CALL_FUNCTION_3   None
254	POP_TOP           None

255	LOAD_FAST         'self'
258	LOAD_ATTR         'namemappers'
261	LOAD_ATTR         'append'
264	LOAD_FAST         'mapper'
...
Syntax error at or near `POP_BLOCK' token at offset 274
