...
0	LOAD_GLOBAL       'False'
3	STORE_FAST        'close_source'

6	LOAD_GLOBAL       'hasattr'
9	LOAD_FAST         'source'
12	LOAD_CONST        'read'
15	CALL_FUNCTION_2   None
18	POP_JUMP_IF_TRUE  '45'

21	LOAD_GLOBAL       'open'
24	LOAD_FAST         'source'
27	LOAD_CONST        'rb'
30	CALL_FUNCTION_2   None
33	STORE_FAST        'source'

36	LOAD_GLOBAL       'True'
39	STORE_FAST        'close_source'
42	JUMP_FORWARD      '45'
45_0	COME_FROM         '42'

45	SETUP_FINALLY     '146'

48	LOAD_FAST         'parser'
51	POP_JUMP_IF_TRUE  '75'

54	LOAD_GLOBAL       'XMLParser'
57	LOAD_CONST        'target'
60	LOAD_GLOBAL       'TreeBuilder'
63	CALL_FUNCTION_0   None
66	CALL_FUNCTION_256 None
69	STORE_FAST        'parser'
72	JUMP_FORWARD      '75'
75_0	COME_FROM         '72'
...
93	LOAD_FAST         'data'
96	POP_JUMP_IF_TRUE  '103'

99	BREAK_LOOP        None
100	JUMP_FORWARD      '103'
103_0	COME_FROM         '100'

103	LOAD_FAST         'parser'
106	LOAD_ATTR         'feed'
109	LOAD_FAST         'data'
...
146	LOAD_FAST         'close_source'
149	POP_JUMP_IF_FALSE '165'
...
165_0	COME_FROM         '162'
165	END_FINALLY       None

Syntax error at or near `POP_BLOCK' token at offset 119
...
98	LOAD_FAST         'self'
101	LOAD_ATTR         '_parser'
104	LOAD_CONST        None
107	COMPARE_OP        'is'
110	POP_JUMP_IF_FALSE '159'
...
150	LOAD_GLOBAL       'StopIteration'
153	RAISE_VARARGS_1   None
156	JUMP_FORWARD      '159'
159_0	COME_FROM         '156'

159	LOAD_FAST         'self'
162	LOAD_ATTR         '_events'
165	DELETE_SLICE+0    None

166	LOAD_CONST        0
169	LOAD_FAST         'self'
172	STORE_ATTR        '_index'

175	LOAD_FAST         'self'
178	LOAD_ATTR         '_file'
181	LOAD_ATTR         'read'
184	LOAD_CONST        16384
187	CALL_FUNCTION_1   None
190	STORE_FAST        'data'

193	LOAD_FAST         'data'
196	POP_JUMP_IF_FALSE '253'

199	SETUP_EXCEPT      '222'

202	LOAD_FAST         'self'
205	LOAD_ATTR         '_parser'
208	LOAD_ATTR         'feed'
211	LOAD_FAST         'data'
214	CALL_FUNCTION_1   None
217	POP_TOP           None
218	POP_BLOCK         None
219	JUMP_ABSOLUTE     '280'
222_0	COME_FROM         '199'

222	DUP_TOP           None
223	LOAD_GLOBAL       'SyntaxError'
226	COMPARE_OP        'exception match'
229	POP_JUMP_IF_FALSE '249'
232	POP_TOP           None
233	STORE_FAST        'exc'
236	POP_TOP           None
...
237	LOAD_FAST         'exc'
240	LOAD_FAST         'self'
243	STORE_ATTR        '_error'
246	JUMP_ABSOLUTE     '280'
249	END_FINALLY       None
250_0	COME_FROM         '249'
250	JUMP_BACK         '3'

253	LOAD_FAST         'self'
256	LOAD_ATTR         '_parser'
259	LOAD_ATTR         'close'
262	CALL_FUNCTION_0   None
265	LOAD_FAST         'self'
268	STORE_ATTR        '_root'

271	LOAD_CONST        None
274	LOAD_FAST         'self'
277	STORE_ATTR        '_parser'
280	JUMP_BACK         '3'
283	POP_BLOCK         None
284_0	COME_FROM         '0'
284	LOAD_CONST        None
...
Syntax error at or near `POP_BLOCK' token at offset 283
