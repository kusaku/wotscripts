...
65	LOAD_FAST         'first_buffer'
68	POP_JUMP_IF_FALSE '99'
71	LOAD_FAST         'self'
74	LOAD_ATTR         'document'
77	LOAD_ATTR         'documentElement'
80_0	COME_FROM         '68'
80	POP_JUMP_IF_FALSE '99'

83	LOAD_FAST         'self'
86	LOAD_ATTR         '_setup_subset'
89	LOAD_FAST         'buffer'
...
99	LOAD_GLOBAL       'False'
102	STORE_FAST        'first_buffer'
105	JUMP_BACK         '24'
108	POP_BLOCK         None
109_0	COME_FROM         '21'

109	LOAD_FAST         'parser'
112	LOAD_ATTR         'Parse'
115	LOAD_CONST        ''
118	LOAD_GLOBAL       'True'
121	CALL_FUNCTION_2   None
124	POP_TOP           None
125	POP_BLOCK         None
126	JUMP_FORWARD      '146'
129_0	COME_FROM         '18'

129	DUP_TOP           None
130	LOAD_GLOBAL       'ParseEscape'
133	COMPARE_OP        'exception match'
136	POP_JUMP_IF_FALSE '145'
139	POP_TOP           None
140	POP_TOP           None
141	POP_TOP           None

142	JUMP_FORWARD      '146'
145	END_FINALLY       None
146_0	COME_FROM         '126'
146_1	COME_FROM         '145'

146	LOAD_FAST         'self'
149	LOAD_ATTR         'document'
152	STORE_FAST        'doc'
