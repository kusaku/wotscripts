...
0	LOAD_FAST         'self'
3	LOAD_GLOBAL       'current_process'
6	CALL_FUNCTION_0   None
9	STORE_ATTR        '_manager_server'

12	SETUP_FINALLY     '153'
...
47	LOAD_GLOBAL       'IOError'
50	BUILD_TUPLE_2     None
53	COMPARE_OP        'exception match'
...
69	LOAD_GLOBAL       'threading'
72	LOAD_ATTR         'Thread'
75	LOAD_CONST        'target'
78	LOAD_FAST         'self'
81	LOAD_ATTR         'handle_request'
84	LOAD_CONST        'args'
87	LOAD_FAST         'c'
90	BUILD_TUPLE_1     None
93	CALL_FUNCTION_512 None
96	STORE_FAST        't'

99	LOAD_GLOBAL       'True'
102	LOAD_FAST         't'
105	STORE_ATTR        'daemon'
...
122_0	COME_FROM         '18'
122	POP_BLOCK         None
123	JUMP_FORWARD      '149'
126_0	COME_FROM         '15'

126	DUP_TOP           None
127	LOAD_GLOBAL       'KeyboardInterrupt'
130	LOAD_GLOBAL       'SystemExit'
133	BUILD_TUPLE_2     None
136	COMPARE_OP        'exception match'
139	POP_JUMP_IF_FALSE '148'
142	POP_TOP           None
143	POP_TOP           None
144	POP_TOP           None

145	JUMP_FORWARD      '149'
148	END_FINALLY       None
149_0	COME_FROM         '123'
149_1	COME_FROM         '148'
149	POP_BLOCK         None
150	LOAD_CONST        None
...
162	LOAD_FAST         'self'
165	LOAD_ATTR         'listener'
168	LOAD_ATTR         'close'
171	CALL_FUNCTION_0   None
174	POP_TOP           None
175	END_FINALLY       None
