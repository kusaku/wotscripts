...
class sdist(Command):
    ...
    def read_template--- This code section failed: ---

0	LOAD_GLOBAL       'log'
3	LOAD_ATTR         'info'
6	LOAD_CONST        "reading manifest template '%s'"
9	LOAD_FAST         'self'
12	LOAD_ATTR         'template'
15	CALL_FUNCTION_2   None
18	POP_TOP           None

19	LOAD_GLOBAL       'TextFile'
22	LOAD_FAST         'self'
25	LOAD_ATTR         'template'
28	LOAD_CONST        'strip_comments'

31	LOAD_CONST        1
34	LOAD_CONST        'skip_blanks'

37	LOAD_CONST        1
40	LOAD_CONST        'join_lines'

43	LOAD_CONST        1
46	LOAD_CONST        'lstrip_ws'

49	LOAD_CONST        1
52	LOAD_CONST        'rstrip_ws'

55	LOAD_CONST        1
58	LOAD_CONST        'collapse_join'

61	LOAD_CONST        1
64	CALL_FUNCTION_1537 None
67	STORE_FAST        'template'

70	SETUP_FINALLY     '192'

73	SETUP_LOOP        '188'

76	LOAD_FAST         'template'
79	LOAD_ATTR         'readline'
...
91	LOAD_CONST        None
94	COMPARE_OP        'is'
97	POP_JUMP_IF_FALSE '104'

100	BREAK_LOOP        None
101	JUMP_FORWARD      '104'
104_0	COME_FROM         '101'

104	SETUP_EXCEPT      '127'

107	LOAD_FAST         'self'
110	LOAD_ATTR         'filelist'
113	LOAD_ATTR         'process_template_line'
116	LOAD_FAST         'line'
...
127	DUP_TOP           None
128	LOAD_GLOBAL       'DistutilsTemplateError'
131	LOAD_GLOBAL       'ValueError'
134	BUILD_TUPLE_2     None
137	COMPARE_OP        'exception match'
140	POP_JUMP_IF_FALSE '183'
143	POP_TOP           None
144	STORE_FAST        'msg'
147	POP_TOP           None
...
148	LOAD_FAST         'self'
151	LOAD_ATTR         'warn'
154	LOAD_CONST        '%s, line %d: %s'
157	LOAD_FAST         'template'
160	LOAD_ATTR         'filename'

163	LOAD_FAST         'template'
166	LOAD_ATTR         'current_line'

169	LOAD_FAST         'msg'
172	BUILD_TUPLE_3     None
175	BINARY_MODULO     None
...
Syntax error at or near `POP_BLOCK' token at offset 187
