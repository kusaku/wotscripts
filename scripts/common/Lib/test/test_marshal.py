# Embedded file name: scripts/common/Lib/test/test_marshal.py
...
class IntTestCase(unittest.TestCase):
    ...
    def test_int64(self):
        ...
        maxint64 = 9223372036854775807L
        minint64 = -maxint64 - 1
        for base in (maxint64,
         minint64,
         -maxint64,
         -(minint64 >> 1)):
            while base:
...
class ContainerTestCase(unittest.TestCase):
    d = {'astring': 'foo@bar.baz.spam',
     ...
     'ashortlong': 2L,
     'alist': ['.zyx.41'],
     'atuple': ('.zyx.41', '.zyx.41', '.zyx.41', '.zyx.41', '.zyx.41', '.zyx.41', '.zyx.41', '.zyx.41', '.zyx.41', '.zyx.41'),
     'aboolean': False,
     'aunicode': u'Andr\xe8 Previn'}
...
def test_main():
    test_support.run_unittest(IntTestCase, FloatTestCase, StringTestCase, CodeTestCase, ContainerTestCase, ExceptionTestCase, BugsTestCase)
