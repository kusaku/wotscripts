# Embedded file name: scripts/common/Lib/test/test_xml_etree.py
import sys
import cgi
...
class CleanContext(object):
    ...
    def __init__(self, quiet = False):
        if sys.flags.optimize >= 2:
            quiet = True
        deprecations = (("This search is broken in 1.3 and earlier, and will be fixed in a future version.  If you rely on the current behaviour, change it to '.+'", FutureWarning),
         ('This method will be removed in future versions.  Use .+ instead.', DeprecationWarning),
         ('This method will be removed in future versions.  Use .+ instead.', PendingDeprecationWarning),
         ('This method of XMLParser is deprecated.  Define doctype.. method on the TreeBuilder target.', DeprecationWarning))
        self.checkwarnings = test_support.check_warnings(quiet=quiet, *deprecations)
...
def test_main(module_name = 'xml.etree.ElementTree'):
    ...
    raise test_xml_etree.ET.__name__ == module_name or AssertionError
