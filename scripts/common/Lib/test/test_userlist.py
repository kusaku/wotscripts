# Embedded file name: scripts/common/Lib/test/test_userlist.py
...
def test_main():
    with test_support.check_py3k_warnings(('.+__(get|set|del)slice__ has been removed', DeprecationWarning)):
