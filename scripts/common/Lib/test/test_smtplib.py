# Embedded file name: scripts/common/Lib/test/test_smtplib.py
import asyncore
import email.utils
import socket
import smtpd
...
sim_auth_credentials = {'login': 'TXIuQUBzb21ld2hlcmUuY29t',
 'plain': 'AE1yLkFAc29tZXdoZXJlLmNvbQBzb21lcGFzc3dvcmQ=',
 'cram-md5': 'TXIUQUBZB21LD2HLCMUUY29TIDG4OWQ0MJKWZGQ4ODNMNDA4NTGXMDRLZWMYZJDMODG1'}
...
class SimSMTPServer(smtpd.SMTPServer):
    ...
    def handle_accept(self):
        ...
        self._SMTPchannel = SimSMTPChannel(self._extra_features, self, conn, addr)
...
class SMTPSimTests(unittest.TestCase):
    ...
    def testAUTH_PLAIN(self):
        ...
        smtp = smtplib.SMTP(HOST, self.port, local_hostname='localhost', timeout=15)
        expected_auth_ok = (235, 'plain auth ok')
