# Embedded file name: scripts/common/Lib/test/test_locale.py
...
class FrFRCookedTest(BaseCookedTest):
    cooked_values = {'currency_symbol': '\xe2\x82\xac',
     'decimal_point': ',',
     'frac_digits': 2,
     'grouping': [3, 3, 0],
     'int_curr_symbol': 'EUR ',
...
class TestLocaleFormatString(unittest.TestCase):
    ...
    def test_percent_escape(self):
        self.assertEqual(locale.format_string('%f%%', 1.0), '1.000000%')
