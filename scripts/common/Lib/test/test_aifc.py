# Embedded file name: scripts/common/Lib/test/test_aifc.py
...
class AIFCTest(unittest.TestCase):
    ...
    def test_compress(self):
        ...
        fout.close()
        self.assertLess(os.stat(TESTFN).st_size, os.stat(self.sndfilepath).st_size * 0.75)
        fout = self.fout = aifc.open(TESTFN, 'rb')
        f.rewind()
