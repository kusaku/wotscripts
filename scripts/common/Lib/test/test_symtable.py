# Embedded file name: scripts/common/Lib/test/test_symtable.py
"""
...
class SymtableTest(unittest.TestCase):
    with test_support.check_warnings(('import \\* only allowed at module level', SyntaxWarning)):
    ...
    def test_function_info(self):
        func = self.spam
        self.assertEqual(sorted(func.get_parameters()), ['a',
         'b',
         'kw',
         'var'])
        expected = ['a',
