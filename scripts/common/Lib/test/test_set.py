# Embedded file name: scripts/common/Lib/test/test_set.py
import unittest
...
class TestBinaryOps(unittest.TestCase):
    ...
    def test_eq(self):
        self.assertEqual(self.set, set({2: 1,
         4: 3,
         6: 5}))
    ...
    def test_isdisjoint_superset(self):
        result = self.set.isdisjoint(set([2,
         4,
         6,
         8]))
        self.assertEqual(result, False)
...
class TestUpdateOps(unittest.TestCase):
    ...
    def test_union_superset(self):
        self.set |= set([2,
         ...
         6,
         8])
        self.assertEqual(self.set, set([2,
         4,
         6,
         8]))
