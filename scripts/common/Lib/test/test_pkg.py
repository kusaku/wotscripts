# Embedded file name: scripts/common/Lib/test/test_pkg.py
import sys
import os
import tempfile
import textwrap
...
class Test(unittest.TestCase):
    ...
    def run_code(self, code):
        exec textwrap.dedent(code) in globals(), {'self': self}
    ...
    def test_4(self):
        hier = [('t4.py', "raise RuntimeError('Shouldnt load t4.py')"),
         ('t4', None),
         ('t4 __init__' + os.extsep + 'py', ''),
         ('t4 sub.py', "raise RuntimeError('Shouldnt load sub.py')"),
         ('t4 sub', None),
         ('t4 sub __init__' + os.extsep + 'py', ''),
         ('t4 sub subsub' + os.extsep + 'py', "raise RuntimeError('Shouldnt load subsub.py')"),
         ('t4 sub subsub', None),
    ...
    def test_5(self):
        hier = [('t5', None),
         ...
         ('t5 foo' + os.extsep + 'py', 'from . import string; assert string.spam == 1')]
        self.mkhier(hier)
        import t5
        s = "\n            from t5 import *\n            self.assertEqual(dir(), ['foo', 'self', 'string', 't5'])\n            "
        self.run_code(s)
        import t5
        self.assertEqual(fixdir(dir(t5)), ['__doc__',
         '__file__',
         '__name__',
         '__package__',
         '__path__',
         ...
         'string',
         't5'])
        self.assertEqual(fixdir(dir(t5.foo)), ['__doc__',
         '__file__',
         '__name__',
         '__package__',
         'string'])
        self.assertEqual(fixdir(dir(t5.string)), ['__doc__',
         '__file__',
         '__name__',
         '__package__',
         'spam'])
    ...
    def test_6(self):
        ...
        self.mkhier(hier)
        import t6
        self.assertEqual(fixdir(dir(t6)), ['__all__',
         '__doc__',
         '__file__',
         '__name__',
         '__package__',
    ...
    def test_7(self):
        hier = [('t7', None),
         ...
         ('t7 sub' + os.extsep + 'py', "raise RuntimeError('Shouldnt load sub.py')"),
         ('t7 sub', None),
         ('t7 sub __init__' + os.extsep + 'py', ''),
         ('t7 sub ' + os.extsep + 'py', "raise RuntimeError('Shouldnt load subsub.py')"),
         ('t7 sub subsub', None),
         ('t7 sub subsub __init__' + os.extsep + 'py', 'spam = 1')]
        self.mkhier(hier)
        t7, sub, subsub = (None, None, None)
        import t7 as tas
        self.assertEqual(fixdir(dir(tas)), ['__doc__',
         '__file__',
         '__name__',
         '__package__',
         '__path__'])
        ...
        self.assertEqual(fixdir(dir(subpar)), ['__doc__',
         '__file__',
         '__name__',
         '__package__',
         '__path__'])
        ...
        self.assertEqual(fixdir(dir(subsubsub)), ['__doc__',
         '__file__',
         '__name__',
         '__package__',
         '__path__',
