# Embedded file name: scripts/common/Lib/test/test_getargs2.py
import unittest
...
from _testcapi import UCHAR_MAX, USHRT_MAX, UINT_MAX, ULONG_MAX, INT_MAX, INT_MIN, LONG_MIN, LONG_MAX, PY_SSIZE_T_MIN, PY_SSIZE_T_MAX, SHRT_MIN, SHRT_MAX
...
class LongLong_TestCase(unittest.TestCase):
    ...
    def test_L(self):
        ...
        with warnings.catch_warnings():
            warnings.filterwarnings('error', category=DeprecationWarning, message='.*integer argument expected, got float', module='unittest')
