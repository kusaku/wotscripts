# Embedded file name: scripts/common/Lib/test/test_pyexpat.py
import StringIO, sys
import unittest
...
class NamespaceSeparatorTest(unittest.TestCase):
    ...
    def test_illegal(self):
        try:
            ...
            self.assertEqual(str(e), 'ParserCreate() argument 2 must be string or None, not int')
...
class BufferTextTest(unittest.TestCase):
    ...
    def test3(self):
        ...
        self.assertEqual(self.stuff, ['<a>',
         ...
         '2',
         '<c>',
         '3'], 'buffered text not properly split')
    ...
    def test6(self):
        ...
        self.assertEqual(self.stuff, ['<a>',
         ...
         '</c>',
         '345',
         '</a>'], 'buffered text not properly split')
...
def test_main():
    run_unittest(SetAttributeTest, ParseTest, NamespaceSeparatorTest, InterningTest, BufferTextTest, HandlerExceptionTest, PositionTest, sf1296433Test, ChardataBufferTest, MalformedInputText)
