# Embedded file name: scripts/common/Lib/test/test_userstring.py
import string
...
def test_main():
    with warnings.catch_warnings():
        warnings.filterwarnings('ignore', '.*MutableString has been removed', DeprecationWarning)
        warnings.filterwarnings('ignore', '.*__(get|set|del)slice__ has been removed', DeprecationWarning)
