# Embedded file name: scripts/common/Lib/test/list_tests.py
"""
...
class CommonTest(seq_tests.CommonTest):
    ...
    def test_setitem(self):
        ...
        a[1] = 6
        a[2] = 7
        self.assertEqual(a, self.type2test([5,
         6,
         7,
         3,
         4]))
    ...
    def test_insert(self):
        ...
        b.insert(-200, 'left')
        b.insert(200, 'right')
        self.assertEqual(b, self.type2test(['left',
         -2,
         -1,
         0,
         0,
    ...
    def test_index(self):
        ...
        self.assertEqual(a, self.type2test([-2,
         -1,
         0,
         1,
         2]))
    ...
    def test_sort(self):
        with test_support.check_py3k_warnings(('the cmp argument is not supported', DeprecationWarning)):
            self._test_sort()
    ...
    def _test_sort(self):
        ...
        u = self.type2test([2,
         ...
         -2])
        u.sort()
        self.assertEqual(u, self.type2test([-2,
         -1,
         0,
         1,
         2]))
    ...
    def test_imul(self):
        u = self.type2test([0, 1])
        u *= 3
        self.assertEqual(u, self.type2test([0,
         1,
         0,
         1,
         0,
    ...
    def test_extendedslicing(self):
        ...
        a[::-1] = a
        self.assertEqual(a, self.type2test([3,
         2,
         1,
         0]))
        a = self.type2test(range(10))
        ...
        self.assertEqual(a, self.type2test([0,
         ...
         9]))
        a = self.type2test(range(10))
        del a[9::17498005798264095394980017816940970922825355447145699491406164851279623993595007385788105416184430592L]
        return
