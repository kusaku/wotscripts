# Embedded file name: scripts/common/Lib/test/test_functools.py
import functools
import sys
import unittest
...
class TestPartial(unittest.TestCase):
    ...
    def test_kw_combinations(self):
        ...
        self.assertEqual(p(b=2), ((), {'a': 1,
          'b': 2}))
        self.assertEqual(p(a=3, b=2), ((), {'a': 3,
          'b': 2}))
    ...
    def test_no_side_effects(self):
        ...
        args1, kw1 = p(1, b=2)
        self.assertTrue(args1 == (0, 1) and kw1 == {'a': 1,
         'b': 2})
        args2, kw2 = p()
...
class TestWraps(TestUpdateWrapper):
    ...
    @unittest.skipIf(not sys.flags.optimize <= 1, 'Docstrings are omitted with -O2 and above')
    def test_default_update_doc(self):
        wrapper = self._default_update()
        self.assertEqual(wrapper.__doc__, 'This is a test')
...
class TestReduce(unittest.TestCase):
    ...
    def test_reduce(self):
        ...
        self.assertEqual(reduce(lambda x, y: x + y, [['a', 'c'], [], ['d', 'w']], []), ['a',
         'c',
         'd',
         'w'])
...
class TestCmpToKey(unittest.TestCase):
    ...
    def test_cmp_to_key(self):
        ...
        self.assertEqual(sorted(range(5), key=functools.cmp_to_key(mycmp)), [4,
         3,
         2,
         1,
         0])
