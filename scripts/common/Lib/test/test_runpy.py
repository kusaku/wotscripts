# Embedded file name: scripts/common/Lib/test/test_runpy.py
import unittest
import os
import os.path
import sys
...
from test.script_helper import temp_dir, make_script, compile_script, make_pkg, make_zip_script, make_zip_pkg
...
class RunModuleCodeTest(unittest.TestCase):
    ...
    def test_run_module_code(self):
        ...
        saved_argv0 = sys.argv[0]
        d2 = _run_module_code(self.test_source, d1, name, file, loader, package)
...
class RunModuleTest(unittest.TestCase):
    ...
    def _check_relative_imports(self, depth, run_name = None):
        ...
        pkg_dir, mod_fname, mod_name = self._make_pkg(contents, depth)
        try:
...
class RunPathTest(unittest.TestCase):
    ...
    def _check_script(self, script_name, expected_name, expected_file, expected_argv0, expected_package):
    ...
    def test_basic_script(self):
        with temp_dir() as script_dir:
            ...
            self._check_script(script_name, '<run_path>', script_name, script_name, None)
        return
    ...
    def test_directory(self):
        with temp_dir() as script_dir:
            mod_name = '__main__'
            script_name = self._make_test_script(script_dir, mod_name)
            self._check_script(script_dir, '<run_path>', script_name, script_dir, '')
