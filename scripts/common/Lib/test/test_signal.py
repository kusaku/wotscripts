# Embedded file name: scripts/common/Lib/test/test_signal.py
import unittest
...
class InterProcessSignalTests(unittest.TestCase):
    ...
    def handlerA(self, signum, frame):
        ...
        if test_support.verbose:
            print 'handlerA invoked from signal %s at:\n%s' % (signum, self.format_frame(frame, limit=1))
    ...
    @unittest.skipIf(sys.platform == 'freebsd6', 'inter process signals not reliable (do not mix well with threading) on freebsd6')
    def test_main(self):
...
class ItimerTest(unittest.TestCase):
    ...
    @unittest.skipIf(sys.platform in ('freebsd6', 'netbsd5'), 'itimer not reliable (does not mix well with threading) on some BSDs.')
    ...
    @unittest.skipIf(sys.platform == 'freebsd6', 'itimer not reliable (does not mix well with threading) on freebsd6')
...
def test_main():
    test_support.run_unittest(BasicSignalTests, InterProcessSignalTests, WakeupSignalTests, SiginterruptTest, ItimerTest, WindowsSignalTests)
