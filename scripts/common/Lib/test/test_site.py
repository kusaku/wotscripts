# Embedded file name: scripts/common/Lib/test/test_site.py
"""Tests for 'site'.
...
class HelperFunctionsTests(unittest.TestCase):
    ...
    def test_init_pathinfo(self):
        ...
        for entry in [ site.makepath(path)[1] for path in sys.path if path and os.path.isdir(path) ]:
    ...
    def test_addpackage_import_bad_syntax(self):
        ...
        self.assertRegexpMatches(err_out.getvalue(), 'import bad\\)syntax')
    ...
    def test_s_option(self):
        ...
        rc = subprocess.call([sys.executable,
         '-s',
         '-c',
         'import sys; sys.exit(%r in sys.path)' % usersite], env=env)
    ...
    def test_getsitepackages(self):
        ...
        if sys.platform in ('os2emx', 'riscos'):
            ...
            wanted = os.path.join('/Library', sysconfig.get_config_var('PYTHONFRAMEWORK'), sys.version[:3], 'site-packages')
