# Embedded file name: scripts/common/Lib/test/test_structmembers.py
from _testcapi import _test_structmembersType, CHAR_MAX, CHAR_MIN, UCHAR_MAX, SHRT_MAX, SHRT_MIN, USHRT_MAX, INT_MAX, INT_MIN, UINT_MAX, LONG_MAX, LONG_MIN, ULONG_MAX, LLONG_MAX, LLONG_MIN, ULLONG_MAX
import unittest
from test import test_support
ts = _test_structmembersType(False, 1, 2, 3, 4, 5, 6, 7, 8, 9.99999, 10.101010101, 'hi')
