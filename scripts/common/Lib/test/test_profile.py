# Embedded file name: scripts/common/Lib/test/test_profile.py
...
class ProfileTest(unittest.TestCase):
    ...
    def test_calling_conventions(self):
        ...
        for stmt in stmts:
            ...
            stats.print_stats()
            res = s.getvalue()
            self.assertIn(self.expected_list_sort_output, res, "Profiling {0!r} didn't report list.sort:\n{1}".format(stmt, res))
