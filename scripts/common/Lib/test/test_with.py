# Embedded file name: scripts/common/Lib/test/test_with.py
...
class FailureTestCase(unittest.TestCase):
    ...
    def testAssignmentToEmptyTupleError(self):
        self.assertRaisesSyntaxError('with mock as ():\n  pass')
...
class NestedNonexceptionalTestCase(unittest.TestCase, ContextmanagerAssertionMixin):
    ...
    def testMultipleArgBound(self):
        mock_nested = MockNested(mock_contextmanager_generator(), mock_contextmanager_generator(), mock_contextmanager_generator())
...
class NestedWith(unittest.TestCase):
    ...
    def testNoExceptions(self):
        with self.Dummy() as a:
            with self.Dummy() as b:
    ...
    def testExceptionInExit(self):
        body_executed = False
        with self.Dummy(gobble=True) as a:
            with self.ExitRaises():
                body_executed = True
        self.assertTrue(a.enter_called)
        self.assertTrue(a.exit_called)
    ...
    def testEnterReturnsTuple(self):
        with self.Dummy(value=(1, 2)) as a1, a2:
            with self.Dummy(value=(10, 20)) as b1, b2:
...
def test_main():
    run_unittest(FailureTestCase, NonexceptionalTestCase, NestedNonexceptionalTestCase, ExceptionalTestCase, NonLocalFlowControlTestCase, AssignmentTargetTestCase, ExitSwallowsExceptionTestCase, NestedWith)
