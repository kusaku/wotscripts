# Embedded file name: scripts/common/Lib/test/test_funcattrs.py
...
class FunctionPropertiesTest(FuncAttrsTest):
    ...
    def test_dir_includes_correct_attrs(self):
        ...
        self.assertIn('known_attr', dir(self.f.a), 'set attribute on unbound method implementation in class not in dir')
        self.assertIn('known_attr', dir(self.fi.a), 'set attribute on unbound method implementations, should show up in next dir')
    ...
    def test_func_code(self):
        ...
        try:
            ...
            self.fail('func_code with different numbers of free vars should not be possible')
    ...
    def test_func_default_args(self):
        ...
        try:
            ...
            self.fail('func_defaults does not update; deleting it does not remove requirement')
...
class ArbitraryFunctionAttrTest(FuncAttrsTest):
    ...
    def test_setting_attrs_duplicates(self):
        try:
            ...
            self.fail('setting arbitrary attribute in unbound function  should raise AttributeError')
...
def test_main():
    test_support.run_unittest(FunctionPropertiesTest, InstancemethodAttrTest, ArbitraryFunctionAttrTest, FunctionDictsTest, FunctionDocstringTest, StaticMethodAttrsTest)
