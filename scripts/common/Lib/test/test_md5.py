# Embedded file name: scripts/common/Lib/test/test_md5.py
import warnings
...
class MD5_Test(unittest.TestCase):
    ...
    def test_basics(self):
        ...
        eq('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789', 'd174ab98d277d9f5a5611c2c9f419d9f')
        eq('12345678901234567890123456789012345678901234567890123456789012345678901234567890', '57edf4a22be3c955ac49da2e2107b67a')
