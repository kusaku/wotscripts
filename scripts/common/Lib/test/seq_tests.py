# Embedded file name: scripts/common/Lib/test/seq_tests.py
"""
...
class CommonTest(unittest.TestCase):
    ...
    def test_getslice(self):
        ...
        self.assertEqual(u[1:None], self.type2test([1,
         2,
         3,
         4]))
        ...
        self.assertEqual(u[::-1], self.type2test([4,
         3,
         2,
         1,
         0]))
    ...
    def test_bigrepeat(self):
        ...
        if sys.maxint <= 2147483647:
            x = self.type2test([0])
            x *= 65536
            self.assertRaises(MemoryError, x.__mul__, 65536)
            if hasattr(x, '__imul__'):
                self.assertRaises(MemoryError, x.__imul__, 65536)
