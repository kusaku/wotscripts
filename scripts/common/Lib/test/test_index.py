# Embedded file name: scripts/common/Lib/test/test_index.py
import unittest
...
class ClassicSeq(_BaseSeq):
    pass


class NewSeq(_BaseSeq, object):
    pass


class ClassicSeqDeprecated(_GetSliceMixin, ClassicSeq):
    pass


class NewSeqDeprecated(_GetSliceMixin, NewSeq):
    pass
...
class OverflowTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.pos = 1267650600228229401496703205376L
        self.neg = -self.pos
...
def test_main():
    test_support.run_unittest(BaseTestCase, ListTestCase, TupleTestCase, ByteArrayTestCase, StringTestCase, UnicodeTestCase, ClassicSeqTestCase, NewSeqTestCase, XRangeTestCase, OverflowTestCase)
    with test_support.check_py3k_warnings():
        test_support.run_unittest(ClassicSeqDeprecatedTestCase, NewSeqDeprecatedTestCase)
