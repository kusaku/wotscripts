# Embedded file name: scripts/common/Lib/test/test_array.py
...
class NumberTest(BaseTest):
    ...
    def test_extslice(self):
        ...
        self.assertEqual(a[::-1], array.array(self.typecode, [4,
         3,
         2,
         1,
         0]))
    ...
    def test_delslice(self):
        ...
        a = array.array(self.typecode, range(5))
        del a[1::-2]
        self.assertEqual(a, array.array(self.typecode, [0,
         2,
         3,
         4]))
    ...
    def test_assignment(self):
        ...
        self.assertEqual(a, array.array(self.typecode, [42,
         1,
         42,
         3,
         42,
        ...
        a[::-1] = a
        self.assertEqual(a, array.array(self.typecode, [3,
         2,
         1,
         0]))
        a = array.array(self.typecode, range(10))
    ...
    def test_subclassing(self):
        ...
        a = ExaggeratingArray(self.typecode, [3,
         6,
         7,
         11], 4)
