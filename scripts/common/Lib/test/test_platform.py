# Embedded file name: scripts/common/Lib/test/test_platform.py
import sys
import os
import unittest
import platform
...
class PlatformTest(unittest.TestCase):
    ...
    if hasattr(os, 'symlink'):
        ...
        def test_architecture_via_symlink(self):
            ...
            def get(python):
                cmd = [python, '-c', 'import platform; print platform.architecture()']
    ...
    def test_sys_version(self):
        ...
        sys_versions = {('2.6.1 (r261:67515, Dec  6 2008, 15:26:00) \n[GCC 4.0.1 (Apple Computer, Inc. build 5370)]', ('CPython', 'tags/r261', '67515'), self.save_platform): ('CPython',
                                                                                                                                                                '2.6.1',
                                                                                                                                                                'tags/r261',
                                                                                                                                                                '67515',
                                                                                                                                                                ('r261:67515', 'Dec  6 2008 15:26:00'),
                                                                                                                                                                'GCC 4.0.1 (Apple Computer, Inc. build 5370)'),
         ('IronPython 2.0 (2.0.0.0) on .NET 2.0.50727.3053', None, 'cli'): ('IronPython',
                                                                            '2.0.0',
                                                                            '',
                                                                            '',
                                                                            ('', ''),
                                                                            '.NET 2.0.50727.3053'),
         ('2.5 (trunk:6107, Mar 26 2009, 13:02:18) \n[Java HotSpot(TM) Client VM ("Apple Computer, Inc.")]', ('Jython', 'trunk', '6107'), 'java1.5.0_16'): ('Jython',
                                                                                                                                                            '2.5.0',
                                                                                                                                                            'trunk',
                                                                                                                                                            '6107',
                                                                                                                                                            ('trunk:6107', 'Mar 26 2009'),
                                                                                                                                                            'java1.5.0_16'),
         ('2.5.2 (63378, Mar 26 2009, 18:03:29)\n[PyPy 1.0.0]', ('PyPy', 'trunk', '63378'), self.save_platform): ('PyPy',
                                                                                                                  '2.5.2',
                                                                                                                  'trunk',
                                                                                                                  '63378',
                                                                                                                  ('63378', 'Mar 26 2009'),
    ...
    def test_parse_release_file(self):
        for input, output in (('SuSE Linux 9.3 (x86-64)', ('SuSE Linux ', '9.3', 'x86-64')),
...
def test_main():
    test_support.run_unittest(PlatformTest)
