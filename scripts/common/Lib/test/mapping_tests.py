# Embedded file name: scripts/common/Lib/test/mapping_tests.py
import unittest
import UserDict
import test_support
...
class TestMappingProtocol(BasicTestMappingProtocol):
    ...
    def test_constructor(self):
        ...
        self.assertEqual(self.type2test(x=1, y=2), {'x': 1,
         'y': 2})
    ...
    def test_update(self):
        ...
        self.assertEqual(d, {'x': 1,
         'y': 2})
        d = self._full_mapping({1: 3,
         2: 4})
        d.update(self._full_mapping({1: 2,
         3: 4,
         5: 6}).iteritems())
    ...
    def test_fromkeys(self):
        self.assertEqual(self.type2test.fromkeys('abc'), {'a': None,
         'b': None,
         'c': None})
        d = self._empty_mapping()
    ...
    def test_pop(self):
        ...
        x = 4503599627370496L
        y = 4503599627370496L
        h = self._full_mapping({x: 'anything',
         y: 'something else'})
