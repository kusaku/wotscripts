# Embedded file name: scripts/common/Lib/test/test_macpath.py
import macpath
...
class MacPathTestCase(unittest.TestCase):
    ...
    def test_split(self):
        ...
        self.assertEqual(split('conky:mountpoint:foo:bar'), ('conky:mountpoint:foo', 'bar'))
        self.assertEqual(split(':'), ('', ''))
        self.assertEqual(split(':conky:mountpoint:'), (':conky:mountpoint', ''))
    ...
    def test_normpath(self):
        for path in (u'', u'.', u'/', u'\\', u':', u'///foo/.//bar//'):
            self.assertIsInstance(macpath.normpath(path), unicode, 'normpath() returned str instead of unicode')
