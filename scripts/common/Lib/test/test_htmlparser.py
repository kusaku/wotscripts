# Embedded file name: scripts/common/Lib/test/test_htmlparser.py
...
class HTMLParserTestCase(TestCaseBase):
    ...
    def test_bad_nesting(self):
        self._run_check('<a><b></a></b>', [('starttag', 'a', []),
         ('starttag', 'b', []),
         ('endtag', 'a'),
         ('endtag', 'b')])
    ...
    def test_slashes_in_starttag(self):
        ...
        expected = [('startendtag', 'img', [('width', '902'),
           ('height', '250px'),
    ...
    def test_cdata_content(self):
        contents = ['<!-- not a comment --> &not-an-entity-ref;',
         "<not a='start tag'>",
         '<a href="" /> <p> <span></span>',
         'foo = "</scr" + "ipt>";',
         'foo = "</SCRIPT" + ">";',
        ...
        for content in contents:
            for element in elements:
                ...
                s = u'<{element}>{content}</{element}>'.format(element=element, content=content)
    ...
    def test_cdata_with_closing_tags(self):
        ...
        for element in [' script',
         ...
         'script\n',
         '\nscript\n']:
            s = u'<script>{content}</{element}>'.format(element=element, content=content)
            self._run_check(s, [('starttag', 'script', []), ('data', content), ('endtag', 'script')], collector=Collector)
...
class AttributesTestCase(TestCaseBase):
    ...
    def test_attr_nonascii(self):
        self._run_check(u'<img src=/foo/bar.png alt=\u4e2d\u6587>', [('starttag', 'img', [('src', '/foo/bar.png'), ('alt', u'\u4e2d\u6587')])])
        self._run_check(u"<a title='\u30c6\u30b9\u30c8' href='\u30c6\u30b9\u30c8.html'>", [('starttag', 'a', [('title', u'\u30c6\u30b9\u30c8'), ('href', u'\u30c6\u30b9\u30c8.html')])])
        self._run_check(u'<a title="\u30c6\u30b9\u30c8" href="\u30c6\u30b9\u30c8.html">', [('starttag', 'a', [('title', u'\u30c6\u30b9\u30c8'), ('href', u'\u30c6\u30b9\u30c8.html')])])
    ...
    def test_entityrefs_in_attributes(self):
        self._run_check("<html foo='&euro;&amp;&#97;&#x61;&unsupported;'>", [('starttag', 'html', [('foo', u'\u20ac&aa&unsupported;')])])
    ...
    def test_malformed_attributes(self):
        ...
        expected = [('starttag', 'a', [('href', "test'style='color:red;bad1'")]),
         ('data', 'test - bad1'),
         ('endtag', 'a'),
    ...
    def test_broken_comments(self):
        ...
        expected = [('comment', ' not really a comment '),
