# Embedded file name: scripts/common/Lib/test/test_decimal.py
"""
...
from decimal import *
import numbers
from test.test_support import run_unittest, run_doctest, is_resource_enabled, check_py3k_warnings
import random
try:
    import threading
except ImportError:
...
def init():
    ...
    DefaultTestContext = Context(prec=9, rounding=ROUND_HALF_EVEN, traps=dict.fromkeys(Signals, 0))
...
nameAdapter = {'and': 'logical_and',
 ...
 'tosci': 'to_sci_string',
 'xor': 'logical_xor'}
LOGICAL_FUNCTIONS = ('is_canonical',
 'is_finite',
 'is_infinite',
 'is_nan',
 'is_normal',
...
class DecimalTest(unittest.TestCase):
    ...
    def eval_equation(self, s):
        ...
        self.assertItemsEqual(myexceptions, theirexceptions, 'Incorrect flags set in ' + s + ' -- got ' + str(myexceptions))
...
class DecimalImplicitConstructionTest(unittest.TestCase):
    ...
    def test_implicit_from_int(self):
        ...
        self.assertEqual(Decimal(5) + 123456789000L, Decimal(123456789000L))
...
class DecimalFormatTest(unittest.TestCase):
    ...
    def test_n_format(self):
        ...
        self.assertEqual(get_fmt(1234567890123L, crazy), '123456-78-9012-3')
...
class DecimalUsabilityTest(unittest.TestCase):
    ...
    def test_hash_method(self):
        ...
        hash(Decimal('nan123'))
        hash(Decimal('-NaN'))
        test_values = [ Decimal(sign * (2 ** m + n)) for m in [0,
         14,
         15,
         16,
         17,
         ...
         64,
         65,
         66] for n in range(-10, 10) for sign in [-1, 1] ]
        test_values.extend([Decimal('-0'),
         Decimal('0.00'),
         Decimal('-0.000'),
         Decimal('0E10'),
         Decimal('-0E12'),
         ...
         Decimal('1230E100'),
         Decimal('-4.5678E50'),
         Decimal(18446744073709551616L + 4294967296L - 1),
         Decimal('1.634E100'),
         Decimal('90.697E100'),
         Decimal('188.83E100'),
         Decimal('1652.9E100'),
...
class DecimalPythonAPItests(unittest.TestCase):
    ...
    def test_from_float(self):
        ...
        self.assertEqual(str(r), '0.1000000000000000055511151231257827021181583404541015625')
        bigint = 12345678901234567890123456789L
...
class ContextAPItests(unittest.TestCase):
    ...
    def test_equality_with_other_types(self):
        self.assertIn(Decimal(10), ['a',
         1.0,
         Decimal(10),
         (1, 2),
         {}])
        self.assertNotIn(Decimal(10), ['a',
         1.0,
         (1, 2),
         {}])
...
class ContextFlags(unittest.TestCase):
    ...
    def test_flags_irrelevant(self):
        ...
        operations = [(context._apply, [Decimal('100E-1000000009')]),
        ...
        for fn, args in operations:
            ...
            for extra_flags in flagsets:
                ...
                self.assertItemsEqual(new_flags, expected_flags, 'operation raises different flags depending on flags set: ' + 'expected %s, got %s' % (expected_flags, new_flags))
...
def test_main(arith = False, verbose = None, todo_tests = None, debug = None):
    ...
    if todo_tests is None:
        test_classes = [DecimalExplicitConstructionTest,
