# Embedded file name: scripts/common/Lib/test/test_codeccallbacks.py
...
class CodecCallbackTest(unittest.TestCase):
    ...
    def test_unicodetranslateerror(self):
        self.check_exceptionobjectargs(UnicodeTranslateError, [u'g\xfcrk',
         1,
         2,
         'ouch'], "can't translate character u'\\xfc' in position 1: ouch")
        self.check_exceptionobjectargs(UnicodeTranslateError, [u'g\u0100rk',
         1,
         2,
         'ouch'], "can't translate character u'\\u0100' in position 1: ouch")
        self.check_exceptionobjectargs(UnicodeTranslateError, [u'g\uffffrk',
         1,
         2,
         'ouch'], "can't translate character u'\\uffff' in position 1: ouch")
        if sys.maxunicode > 65535:
            self.check_exceptionobjectargs(UnicodeTranslateError, [u'g\U00010000rk',
             1,
             2,
    ...
    def test_badandgoodstrictexceptions(self):
        ...
        self.assertRaises(UnicodeEncodeError, codecs.strict_errors, UnicodeEncodeError('ascii', u'\u3042', 0, 1, 'ouch'))
    ...
    def test_badandgoodignoreexceptions(self):
        ...
        self.assertEqual(codecs.ignore_errors(UnicodeEncodeError('ascii', u'\u3042', 0, 1, 'ouch')), (u'', 1))
        self.assertEqual(codecs.ignore_errors(UnicodeDecodeError('ascii', '\xff', 0, 1, 'ouch')), (u'', 1))
        self.assertEqual(codecs.ignore_errors(UnicodeTranslateError(u'\u3042', 0, 1, 'ouch')), (u'', 1))
    ...
    def test_badandgoodreplaceexceptions(self):
        ...
        self.assertEqual(codecs.replace_errors(UnicodeEncodeError('ascii', u'\u3042', 0, 1, 'ouch')), (u'?', 1))
        self.assertEqual(codecs.replace_errors(UnicodeDecodeError('ascii', '\xff', 0, 1, 'ouch')), (u'\ufffd', 1))
        self.assertEqual(codecs.replace_errors(UnicodeTranslateError(u'\u3042', 0, 1, 'ouch')), (u'\ufffd', 1))
    ...
    def test_badandgoodxmlcharrefreplaceexceptions(self):
        ...
        self.assertEqual(codecs.xmlcharrefreplace_errors(UnicodeEncodeError('ascii', s, 0, len(s), 'ouch')), (u''.join((u'&#%d;' % ord(c) for c in s)), len(s)))
    ...
    def test_badandgoodbackslashreplaceexceptions(self):
        ...
        self.assertEqual(codecs.backslashreplace_errors(UnicodeEncodeError('ascii', u'\u3042', 0, 1, 'ouch')), (u'\\u3042', 1))
        self.assertEqual(codecs.backslashreplace_errors(UnicodeEncodeError('ascii', u'\x00', 0, 1, 'ouch')), (u'\\x00', 1))
        self.assertEqual(codecs.backslashreplace_errors(UnicodeEncodeError('ascii', u'\xff', 0, 1, 'ouch')), (u'\\xff', 1))
        self.assertEqual(codecs.backslashreplace_errors(UnicodeEncodeError('ascii', u'\u0100', 0, 1, 'ouch')), (u'\\u0100', 1))
        self.assertEqual(codecs.backslashreplace_errors(UnicodeEncodeError('ascii', u'\uffff', 0, 1, 'ouch')), (u'\\uffff', 1))
        if sys.maxunicode > 65535:
            self.assertEqual(codecs.backslashreplace_errors(UnicodeEncodeError('ascii', u'\U00010000', 0, 1, 'ouch')), (u'\\U00010000', 1))
            self.assertEqual(codecs.backslashreplace_errors(UnicodeEncodeError('ascii', u'\U0010ffff', 0, 1, 'ouch')), (u'\\U0010ffff', 1))
