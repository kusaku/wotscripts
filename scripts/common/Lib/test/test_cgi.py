# Embedded file name: scripts/common/Lib/test/test_cgi.py
...
parse_strict_test_cases = [('', ValueError("bad query field: ''")),
 ...
 ('x=1;y=2.0;z=2-3.%2b0', {'x': ['1'],
   'y': ['2.0'],
   'z': ['2-3.+0']}),
 ('Hbc5161168c542333633315dee1182227:key_store_seqid=400006&cuyer=r&view=bustomer&order_id=0bb2e248638833d48cb7fed300000f1b&expire=964546263&lobale=en-US&kid=130003.300038&ss=env', {'Hbc5161168c542333633315dee1182227:key_store_seqid': ['400006'],
   'cuyer': ['r'],
   'expire': ['964546263'],
   'kid': ['130003.300038'],
   'lobale': ['en-US'],
   ...
   'ss': ['env'],
   'view': ['bustomer']}),
 ('group_id=5470&set=custom&_assigned_to=31392&_status=1&_category=100&SUBMIT=Browse', {'SUBMIT': ['Browse'],
   '_assigned_to': ['31392'],
   '_category': ['100'],
   '_status': ['1'],
   'group_id': ['5470'],
...
class CgiTests(unittest.TestCase):
        ...
        for orig, expect in parse_strict_test_cases:
            ...
            if isinstance(expect, dict):
                ...
                for key in expect.keys():
                    ...
                    if single_value:
                        self.assertItemsEqual(sd.values(), first_elts(expect.values()))
                        self.assertItemsEqual(sd.items(), first_second_elts(expect.items()))
    ...
    def testQSAndFormDataFile(self):
        ...
        result.update({'upload': 'this is the content of the fake file\n'})
        v = gen_result(data, environ)
        self.assertEqual(result, v)

    def test_deprecated_parse_qs(self):
        with check_warnings(('cgi.parse_qs is deprecated, use urlparse.parse_qs instead', PendingDeprecationWarning)):
            self.assertEqual({'a': ['A1'],
             'B': ['B3'],
             'b': ['B2']}, cgi.parse_qs('a=A1&b=B2&B=B3'))

    def test_deprecated_parse_qsl(self):
        with check_warnings(('cgi.parse_qsl is deprecated, use urlparse.parse_qsl instead', PendingDeprecationWarning)):
            self.assertEqual([('a', 'A1'), ('b', 'B2'), ('B', 'B3')], cgi.parse_qsl('a=A1&b=B2&B=B3'))
    ...
    def test_parse_header(self):
        ...
        self.assertEqual(cgi.parse_header('text/plain ; charset="us-ascii"'), ('text/plain', {'charset': 'us-ascii'}))
        self.assertEqual(cgi.parse_header('text/plain ; charset="us-ascii"; another=opt'), ('text/plain', {'charset': 'us-ascii',
          'another': 'opt'}))
        ...
        self.assertEqual(cgi.parse_header('attachment; filename="strange;name";size=123;'), ('attachment', {'filename': 'strange;name',
          'size': '123'}))
        self.assertEqual(cgi.parse_header('form-data; name="files"; filename="fo\\"o;bar"'), ('form-data', {'name': 'files',
          'filename': 'fo"o;bar'}))
