# Embedded file name: scripts/common/Lib/test/test_posix.py
...
import unittest
import warnings
_DUMMY_SYMLINK = os.path.join(tempfile.gettempdir(), test_support.TESTFN + '-dummy-symlink')
...
class PosixTester(unittest.TestCase):
    ...
    def test_lchflags_symlink(self):
        ...
        posix.lchflags(_DUMMY_SYMLINK, dummy_symlink_st.st_flags | stat.UF_IMMUTABLE)
        try:
    ...
    def test_getgroups(self):
        ...
        self.assertEqual(set([ int(x) for x in groups.split() ]), set(posix.getgroups() + [posix.getegid()]))
