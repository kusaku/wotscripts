# Embedded file name: scripts/common/Lib/test/test_bigmem.py
...
class StrTest(unittest.TestCase):
    ...
    @precisionbigmemtest(size=_4G // 5, memuse=8)
    ...
    def test_find(self, size):
        ...
        self.assertEqual(s.find('i', sublen), sublen + size + SUBSTR.find('i'))
        self.assertEqual(s.find('i', size), sublen + size + SUBSTR.find('i'))
    ...
    def test_index(self, size):
        ...
        self.assertEqual(s.index('i', sublen), sublen + size + SUBSTR.index('i'))
        self.assertEqual(s.index('i', size), sublen + size + SUBSTR.index('i'))
    ...
    def test_rfind(self, size):
        ...
        self.assertEqual(s.rfind('i', 0, sublen + size), SUBSTR.rfind('i'))
    ...
    def test_rindex(self, size):
        ...
        sublen = len(SUBSTR)
        s = ''.join([SUBSTR, '-' * size, SUBSTR])
        self.assertEqual(s.rindex(' '), sublen + size + SUBSTR.rindex(' '))
        self.assertEqual(s.rindex(SUBSTR), sublen + size)
        self.assertEqual(s.rindex(' ', 0, sublen + size - 1), SUBSTR.rindex(' '))
        self.assertEqual(s.rindex(SUBSTR, 0, sublen + size), 0)
        self.assertEqual(s.rindex('i'), sublen + size + SUBSTR.rindex('i'))
        self.assertEqual(s.rindex('i', 0, sublen), SUBSTR.rindex('i'))
        self.assertEqual(s.rindex('i', 0, sublen + size), SUBSTR.rindex('i'))
    ...
    @bigmemtest(minsize=858993459L, memuse=8)
...
class TupleTest(unittest.TestCase):
    ...
    @bigmemtest(minsize=_2G // 5 + 10, memuse=40)
    def test_contains(self, size):
        t = (1, 2, 3, 4, 5) * size
    ...
    def test_index_and_slice(self, size):
        ...
        self.assertEqual(t[:5], (None, None, None, None, None))
        self.assertEqual(t[-5:], (None, None, None, None, None))
        self.assertEqual(t[20:25], (None, None, None, None, None))
        self.assertEqual(t[-25:-20], (None, None, None, None, None))
        self.assertEqual(t[size - 5:], (None, None, None, None, None))
        self.assertEqual(t[size - 5:size], (None, None, None, None, None))
        self.assertEqual(t[size - 6:size - 2], (None, None, None, None))
    ...
    @bigmemtest(minsize=_2G // 3 + 2, memuse=11)
    def test_repr_small(self, size):
        return self.basic_test_repr(size)

    @bigmemtest(minsize=_2G + 2, memuse=11)
    def test_repr_large(self, size):
        return self.basic_test_repr(size)
...
class ListTest(unittest.TestCase):
    ...
    @bigmemtest(minsize=_2G // 5 + 2, memuse=40)
    def test_count(self, size):
        l = [1,
         2,
         3,
    ...
    @bigmemtest(minsize=_2G // 5 + 4, memuse=40)
