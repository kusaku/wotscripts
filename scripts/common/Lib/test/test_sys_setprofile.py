# Embedded file name: scripts/common/Lib/test/test_sys_setprofile.py
import gc
import pprint
import sys
import unittest
...
def test_main():
    test_support.run_unittest(TestGetProfile, ProfileHookTestCase, ProfileSimulatorTestCase)
