...
20	BUILD_LIST_0      None
23	STORE_FAST        'h'

26	LOAD_FAST         'h'
29	LOAD_ATTR         'append'
32	STORE_FAST        'h_append'

35	SETUP_LOOP        '128'
38	LOAD_GLOBAL       'enumerate'
41	LOAD_GLOBAL       'map'
44	LOAD_GLOBAL       'iter'
47	LOAD_FAST         'iterables'
50	CALL_FUNCTION_2   None
53	CALL_FUNCTION_1   None
56	GET_ITER          None
57	FOR_ITER          '127'
60	UNPACK_SEQUENCE_2 None
63	STORE_FAST        'itnum'
66	STORE_FAST        'it'
...
81	LOAD_FAST         'h_append'
84	LOAD_FAST         'next'
87	CALL_FUNCTION_0   None
90	LOAD_FAST         'itnum'
93	LOAD_FAST         'next'
96	BUILD_LIST_3      None
...
107	DUP_TOP           None
108	LOAD_FAST         '_StopIteration'
111	COMPARE_OP        'exception match'
114	POP_JUMP_IF_FALSE '123'
117	POP_TOP           None
118	POP_TOP           None
119	POP_TOP           None
...
141	SETUP_EXCEPT      '209'

144	SETUP_LOOP        '205'

147	LOAD_FAST         'h'
150	LOAD_CONST        0
153	BINARY_SUBSCR     None
154	DUP_TOP           None
155	UNPACK_SEQUENCE_3 None
158	STORE_FAST        'v'
161	STORE_FAST        'itnum'
164	STORE_FAST        'next'
167	STORE_FAST        's'

170	LOAD_FAST         'v'
173	YIELD_VALUE       None
174	POP_TOP           None
...
181	LOAD_FAST         's'
184	LOAD_CONST        0
187	STORE_SUBSCR      None

188	LOAD_FAST         '_heapreplace'
191	LOAD_FAST         'h'
194	LOAD_FAST         's'
...
209	DUP_TOP           None
210	LOAD_FAST         '_StopIteration'
213	COMPARE_OP        'exception match'
216	POP_JUMP_IF_FALSE '235'
219	POP_TOP           None
220	POP_TOP           None
221	POP_TOP           None

222	LOAD_FAST         '_heappop'
225	LOAD_FAST         'h'
...
Syntax error at or near `POP_BLOCK' token at offset 204
