# Embedded file name: scripts/common/site-packages/Pympler-0.3.0/pympler/asizeof.py
r"""
        ...
        for o in t:
            ...
            if a != s:
                if isinstance(o, (dict,
                 ...
                 bytes)):
                    x = ', expected failure'
                elif isinstance(o, (type, bool, ABCMeta)) and sys.version_info >= (3, 0):
                    x = ', expected failure'
                    ...
                    e += 1
                    if failf:
                        failf('%s vs %s for %s: %s', a, s, _nameof(type(o)), _repr(o))
                if stdf:
                    _printf('flatsize() %s vs sys.getsizeof() %s for %s: %s%s', a, s, _nameof(type(o)), _repr(o), x, file=stdf)
...
if __name__ == '__main__':
    ...
    if _opts('-C'):
        _sizeof_Cdouble = _calcsize('d')
        _sizeof_Cssize_t = _calcsize('z')
