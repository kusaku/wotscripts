# Embedded file name: scripts/common/site-packages/Pympler-0.3.0/pympler/classtracker.py
"""
...
class ClassTracker(object):
    ...
    def _inject_constructor(self, cls, func, name, resolution_level, keep, trace):
        ...
        self._observers[cls] = _ClassObserver(constructor, name, resolution_level, keep, trace)
        cls.__init__ = instancemethod(lambda *args, **kwds: func(self._observers[cls], *args, **kwds), None, cls)
        return
