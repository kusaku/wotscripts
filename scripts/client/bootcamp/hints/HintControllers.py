...
def createPrimaryHintController(hintId, typeId, completed, timeCompleted, timeCooldown, message, voiceover):
    if BattleReplay.g_replayCtrl.isRecording:
        return PrimaryHintControllerReplayRecorder(hintId, typeId, completed, timeCompleted, timeCooldown, message, voiceover)
    return PrimaryHintController(hintId, typeId, completed, timeCompleted, timeCooldown, message, voiceover)
