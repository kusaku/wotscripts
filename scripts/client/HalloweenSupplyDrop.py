...
class HalloweenSupplyDrop(ClientSelectableCameraObject):
    ...
    def __waitingState(self):
        self.__pauseOpened()
        raise self.__effectsTimeLine['halloween_2017_box_open_hold'] is not None or AssertionError
    ...
    def __startDone(self):
        ...
        self.model.visible and self.__playSFX('supply_drop_disappearing')
        if not self.__effectsTimeLine['halloween_2017_box_sink'] is not None:
    ...
    def __showAndEnable(self):
        if self.model is None:
            ...
            raise self.__effectsTimeLine['halloween_2017_box_on_scene'] is not None or AssertionError
    ...
    def __startAppearance(self):
        if self.model is None:
            ...
            self.__refreshState()
            if not self.__effectsTimeLine['halloween_2017_box_come'] is not None:
                raise AssertionError
                self.__updateEffect('halloween_2017_box_come')
                self.highestdropID > SUPPLY_DROP_LEVEL_ELITE and self.__playSFX('supply_drop_appears_redemption')
    ...
    def __startWaitForOpening(self):
        ...
        if self.__vfxModel is not None:
            self.__vfxModel.visible = True
        raise self.__effectsTimeLine['halloween_2017_box_wait'] is not None or AssertionError
    ...
    def __startOpening(self):
        ...
        raise self.__effectsTimeLine['halloween_2017_box_open'] is not None or AssertionError
