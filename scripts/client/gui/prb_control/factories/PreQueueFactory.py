...
_SUPPORTED_ENTRY_BY_ACTION = {PREBATTLE_ACTION_NAME.RANDOM_QUEUE: (prequeue.PreQueueEntry, (PREBATTLE_ACTION_NAME_TO_QUEUE_TYPE[PREBATTLE_ACTION_NAME.RANDOM_QUEUE], _FLAG.UNDEFINED)),
 ...
 PREBATTLE_ACTION_NAME.FALLOUT_CLASSIC: (prequeue.PreQueueEntry, (PREBATTLE_ACTION_NAME_TO_QUEUE_TYPE[PREBATTLE_ACTION_NAME.FALLOUT_CLASSIC], _FLAG.UNDEFINED)),
 PREBATTLE_ACTION_NAME.FALLOUT_MULTITEAM: (prequeue.PreQueueEntry, (PREBATTLE_ACTION_NAME_TO_QUEUE_TYPE[PREBATTLE_ACTION_NAME.FALLOUT_MULTITEAM], _FLAG.UNDEFINED)),
 PREBATTLE_ACTION_NAME.BATTLE_TUTORIAL: (prequeue.PreQueueEntry, (PREBATTLE_ACTION_NAME_TO_QUEUE_TYPE[PREBATTLE_ACTION_NAME.BATTLE_TUTORIAL], _FLAG.UNDEFINED)),
