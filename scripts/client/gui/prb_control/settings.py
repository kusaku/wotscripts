...
class FUNCTIONAL_FLAG(BitmaskHelper):
    ...
    RANKED = 2097152
    BOOTCAMP = 4194304
    EVENT_BATTLES_2 = 8388608
    DEFAULT = 16777216
    LEGACY_BITMASK = LEGACY_INTRO | LEGACY
    UNIT_BITMASK = UNIT_INTRO | UNIT_BROWSER | UNIT
    PRE_QUEUE_BITMASK = PRE_QUEUE_INTRO | PRE_QUEUE
    MODES_BITMASK = E_SPORT | FALLOUT | TRAINING | BATTLE_SESSION | RANDOM | EVENT | SANDBOX | TUTORIAL | STRONGHOLD | RANKED | BOOTCAMP | EVENT_BATTLES_2
