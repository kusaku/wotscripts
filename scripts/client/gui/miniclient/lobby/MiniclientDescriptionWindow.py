...
class MiniclientDescriptionWindow(object):
    ...
    def __openDescriptionInBrowser(self, event):
        ...
        getBrowserCtrl().load(url='{0}/$LANGUAGE_CODE/greeting/mini_wot/'.format(GUI_SETTINGS.miniclient['webBridgeRootURL']), title=_ms('#miniclient:hangar/miniclient_description_window/title'), browserSize=(780, 450), showCloseBtn=True, showActionBtn=False)(lambda success: True)
