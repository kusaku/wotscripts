...
class CLAN_REQUESTED_DATA_TYPE(CONST_CONTAINER):
    ...
    HOF_USER_EXCLUDE = 48
    HOF_USER_RESTORE = 49
    EVENT_BOARDS_GET_EVENTS_DATA = 50
    EVENT_BOARDS_GET_PLAYER_DATA = 51
    EVENT_BOARDS_JOIN_EVENT = 52
    EVENT_BOARDS_LEAVE_EVENT = 53
    EVENT_BOARDS_GET_MY_EVENT_TOP = 54
    EVENT_BOARDS_GET_MY_LEADERBOARD_POSITION = 55
    EVENT_BOARDS_GET_LEADERBOARD = 56
    EVENT_BOARDS_GET_HANGAR_FLAG = 57
