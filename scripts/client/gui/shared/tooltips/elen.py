...
class ElenPreviewTooltipData(BlocksTooltipData, IGlobalListener):
    ...
    def _getBottom(self, currentEvent):
        ...
        return formatters.packImageTextBlockData(title=text_styles.neutral(_ms(TOOLTIPS.HANGAR_ELEN_BOTTOM_ALLPERIPHERY_HEADER)), desc=text_styles.standard(_ms(TOOLTIPS.HANGAR_ELEN_BOTTOM_ALLPERIPHERY_BODY)), padding=formatters.packPadding(left=20, right=20, top=3, bottom=16))
