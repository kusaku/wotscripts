...
class ToolTipRefSysXPMultiplier(ToolTipBaseData):
    ...
    def __formatPeriod(self, period):
        ...
        if period <= 8760:
            return makeString(TOOLTIPS.TOOLTIPREFSYSXPMULTIPLIER_CONDITIONS_DAYS, daysNum=period / 24)
        return makeString(TOOLTIPS.TOOLTIPREFSYSXPMULTIPLIER_CONDITIONS_OTHER)
