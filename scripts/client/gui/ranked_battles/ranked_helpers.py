...
def getLadderPointsIconBySize(rankSize):
    if rankSize == RANKEDBATTLES_ALIASES.WIDGET_HUGE:
        return RES_ICONS.MAPS_ICONS_RANKEDBATTLES_LADDER_POINT_HUGE
    return RES_ICONS.MAPS_ICONS_RANKEDBATTLES_LADDER_POINT


def getLadderPointsFormatterBySize(rankSize):
    if rankSize == RANKEDBATTLES_ALIASES.WIDGET_HUGE:
        return text_styles.promoTitle
