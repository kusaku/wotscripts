...
class HalloweenAchievementMissionAward(MissionAward):
    ...
    def getBackgroundImage(self):
        return '../maps/icons/quests/awards/halloween_mission_success_bg.png'
...
class HalloweenMissionAward(MissionAward):
    ...
    def getBackgroundImage(self):
        if self.isHalloweenRewardBox:
            return '../maps/icons/quests/awards/halloween_reward_box_bg.png'
        return '../maps/icons/quests/awards/halloween_mission_success_bg.png'
    ...
    def getDescription(self):
        if self.isHalloweenRewardBox:
            return text_styles.promoTitle('#menu:awardWindow/halloweenMission/rewardOpened')
        return text_styles.promoTitle('#menu:awardWindow/mission/complete')

    def getMainStatusText(self):
        if self.isHalloweenRewardBox or not self._quest.getDescription():
            return text_styles.success('#menu:awardWindow/halloweenMission/awardsGranted')
        return text_styles.success(self._quest.getDescription())

    def getNextButtonText(self):
        if self.isHalloweenRewardBox:
            return _ms('#menu:awardWindow/halloweenMission/closeButton')
        return _ms('#menu:awardWindow/halloweenMission/nextButton')

    def getNextButtonTooltip(self):
        if self.isHalloweenRewardBox:
            return None
        else:
            return makeTooltip('#menu:awardWindow/halloweenMission/awardsGranted', '#menu:awardWindow/halloweenMission/nextButton')
...
class PersonalMissionAward(MissionAward):
    ...
    def getMainStatusText(self):
        ...
        if not self._isMainReward:
            return text_styles.concatStylesWithSpace(statusText, text_styles.standard(MENU.AWARDWINDOW_PERSONALMISSION_ALREADYCOMPLETED))
        return statusText

    def getAdditionalStatusText(self):
        if self._isAddReward:
            return text_styles.success(MENU.AWARDWINDOW_PERSONALMISSION_SIDECONDITIONCOMPLETED)
        return text_styles.neutral(MENU.AWARDWINDOW_PERSONALMISSION_SIDECONDITIONNOTCOMPLETED)
    ...
    def getNextQuestConditionsHeader(self):
        if self._nextQuest is not None:
            return text_styles.neutral(PERSONAL_MISSIONS.DETAILEDVIEW_CONDITIONSLABEL)
        else:
            return ''
    ...
    def getNextButtonText(self):
        if self._quest.isFinal():
            return _ms(MENU.AWARDWINDOW_PERSONALMISSION_NEXTBUTTONAWARD)
        return _ms(MENU.AWARDWINDOW_PERSONALMISSION_NEXTBUTTON)
    ...
    def getNextButtonTooltip(self):
        if self._quest.isFinal():
            return makeTooltip(MENU.AWARDWINDOW_PERSONALMISSION_NEXTBUTTONAWARD_TOOLTIP_HEADER, MENU.AWARDWINDOW_PERSONALMISSION_NEXTBUTTONAWARD_TOOLTIP_BODY)
        return makeTooltip(MENU.AWARDWINDOW_PERSONALMISSION_NEXTBUTTON_TOOLTIP_HEADER, MENU.AWARDWINDOW_PERSONALMISSION_NEXTBUTTON_TOOLTIP_BODY)
