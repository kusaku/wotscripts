...
class PersonalMission(Quest):
    ...
    def getConditions(self, isMain = None):
        ...
        if isMain is None:
            ...
            return self.getMainConditions()
        else:
            return self.getAdditionalConditions()
    ...
    def getPawnCost(self):
        if self.isFinal():
            return constants.PERSONAL_QUEST_FINAL_PAWN_COST
        return constants.PERSONAL_QUEST_PAWN_COST
