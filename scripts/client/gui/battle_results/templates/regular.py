...
VEHICLE_STATS_BLOCK_VO_META = base.PropertyMeta((('shots', 0, 'shots'),
 ...
 ('secondaryTurretHits', style.SlashedValuesBlock('secondaryTurretHits'), 'secondaryTurretHits'),
 ('explosionHits', 0, 'explosionHits'),
 ('damageDealt', 0, 'damageDealt'),
 ('multiTurretDamageDealt', style.SlashedValuesBlock('multiTurretDamageDealt'), 'multiTurretDamageDealt'),
