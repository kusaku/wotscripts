...
from gui.battle_results.templates.fortification import SORTIE_BATTLE_COMMON_STATS_BLOCK
from gui.battle_results.templates.fortification import SORTIE_PERSONAL_STATS_BLOCK
from gui.battle_results.templates.fortification import SORTIE_TEAMS_STATS_BLOCK
from gui.battle_results.templates.fortification import FORT_BATTLE_COMMON_STATS_BLOCK
...
__all__ = ('TOTAL_VO_META', 'MULTI_TEAM_TABS_BLOCK', 'REGULAR_TABS_BLOCK', 'VEHICLE_PROGRESS_STATS_BLOCK', 'QUESTS_PROGRESS_STATS_BLOCK', 'REGULAR_COMMON_STATS_BLOCK', 'REGULAR_PERSONAL_STATS_BLOCK', 'REGULAR_TEAMS_STATS_BLOCK', 'REGULAR_TEXT_STATS_BLOCK', 'CLAN_TEXT_STATS_BLOCK', 'SORTIE_BATTLE_COMMON_STATS_BLOCK', 'SORTIE_PERSONAL_STATS_BLOCK', 'SORTIE_TEAMS_STATS_BLOCK', 'FORT_BATTLE_COMMON_STATS_BLOCK', 'STRONGHOLD_BATTLE_COMMON_STATS_BLOCK', 'FALLOUT_COMMON_STATS_BLOCK', 'CYBER_SPORT_BLOCK', 'SANDBOX_PERSONAL_STATS_BLOCK', 'SANDBOX_TEAM_ITEM_STATS_ENABLE', 'SANDBOX_PERSONAL_ACCOUNT_DB_ID')
