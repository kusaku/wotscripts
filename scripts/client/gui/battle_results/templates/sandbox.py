...
SANDBOX_PERSONAL_STATS_BLOCK.addComponent(19, shared.TrueFlag('showNoIncomeAlert'))
SANDBOX_PERSONAL_STATS_BLOCK.addComponent(20, personal.SandboxNoIncomeAlert(field='noIncomeAlert'))
