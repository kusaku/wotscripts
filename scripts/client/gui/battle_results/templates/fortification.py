...
SORTIE_PERSONAL_STATS_BLOCK.addComponent(16, details.GainFortResourceInBattleItem('fortResourceTotal'))
SORTIE_PERSONAL_STATS_BLOCK.addComponent(17, personal.PlayerNoClanFlag('isLegionnaire'))
SORTIE_PERSONAL_STATS_BLOCK.addComponent(18, details.BaseFortResourcesBlock(base.ListMeta(), 'resValues', _RECORD.PERSONAL))
SORTIE_PERSONAL_STATS_BLOCK.addComponent(19, details.PremiumFortResourcesBlock(base.ListMeta(), 'resPremValues', _RECORD.PERSONAL))
SORTIE_PERSONAL_STATS_BLOCK.addComponent(20, details.FortResourceDetailsBlock(base.ListMeta(), 'resourceData', _RECORD.PERSONAL))
