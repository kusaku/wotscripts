...
class HANGAR_ALIASES(object):
    ...
    VEH_PARAM_RENDERER_STATE_SUBTITLE = 'subtitle'
    VEH_PARAM_RENDERER_STATE_SEPARATOR = 'separator'
    VEH_PARAM_RENDERER_STATE_SPACER = 'spacer'
    HALLOWEEN_BATTLE_SELECTOR = 'halloweenBattleTypeSelector'
    HALLOWEEN_BATTLE_SELECTOR_SWF = 'halloweenBattleSel.swf'