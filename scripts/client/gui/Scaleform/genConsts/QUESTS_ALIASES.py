...
class QUESTS_ALIASES(object):
    ...
    PERSONAL_MISSIONS_VEHICLE_SELECTOR_ALIAS = 'PersonalMissionsVehicleSelector'
    VEHICLE_SELECTOR_CAROUSEL_ALIAS = 'VehicleSelectorCarousel'
    VEHICLE_SELECTOR_CAROUSEL_LINKAGE = 'VehicleSelectorCarouselUI'
    PERSONAL_MISSIONS_VEHICLE_SELECTOR_CAROUSEL_ALIAS = 'PersonalMissionSVehicleSelectorCarousel'
    ...
    MISSIONS_VIEW_PY_ALIASES = [MISSIONS_MARATHONS_VIEW_PY_ALIAS,
