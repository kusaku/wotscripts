...
class BATTLE_VIEW_ALIASES(object):
    ...
    MULTI_TURRET_HINT_PANEL = 'multiTurretHintPanel'
    BRIEFING_BANNER = 'briefingBanner'
    LEVIATHAN_PROGRESS_BAR = 'leviathanProgressBar'
    LEVIATHAN_GATE_CAPTURE_BAR = 'leviathanGateCaptureBar'
    PVE_WINLOSE_PANEL = 'pveWinLosePanel'
    PVE_BOSS_LOCATION_MARKER = 'bossLocationMarker'
    EVIL_EYE = 'evilEye'
    PVE_GOAL_PANEL = 'pveGoalPanel'
    MINION_GOAL_PANEL = 'minionDeathPanel'
