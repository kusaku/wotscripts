...
class MENU(object):
    ...
    TANKCAROUSEL_VEHICLESTATES_NEEDPREMIUM = '#menu:tankCarousel/vehicleStates/needPremium'
    TANKCAROUSEL_VEHICLESTATES_NEEDPREMIUM_NOT = '#menu:tankCarousel/vehicleStates/needPremium/not'
    ...
    TANKCAROUSEL_VEHICLESTATES_ENUM = (TANKCAROUSEL_VEHICLESTATES_BATTLE,
     ...
     TANKCAROUSEL_VEHICLESTATES_NEEDPREMIUM,
     TANKCAROUSEL_VEHICLESTATES_NEEDPREMIUM_NOT,
