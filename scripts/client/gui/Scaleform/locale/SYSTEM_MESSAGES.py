...
class SYSTEM_MESSAGES(object):
    ...
    RANKED_NOTIFICATIONS_FINAL_BONUSNAME_POSITION = '#system_messages:ranked/notifications/final/bonusName/position'
    ...
    RANKED_NOTIFICATIONSALL_BONUSNAME_ENUM = (RANKED_NOTIFICATIONS_BONUSNAME_CREDITS,
     ...
     RANKED_NOTIFICATIONS_FINAL_BONUSNAME_POSITION)
