...
class SYSTEM_MESSAGES(object):
    ...
    GIFTTANKWOMAN_SUCCESS = '#system_messages:giftTankwoman/success'
    GIFTTANKWOMAN_SERVER_ERROR = '#system_messages:giftTankwoman/server_error'
    GIFTTANKWOMAN_SERVER_ERROR_WRONG_ARGS_TYPE = '#system_messages:giftTankwoman/server_error/WRONG_ARGS_TYPE'
    ...
    ALL_ENUM = (REPAIR_SUCCESS,
     ...
     GIFTTANKWOMAN_SUCCESS,
     GIFTTANKWOMAN_SERVER_ERROR,
     GIFTTANKWOMAN_SERVER_ERROR_WRONG_ARGS_TYPE,
