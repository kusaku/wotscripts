...
class QUESTS(object):
    ...
    MISSIONS_FILTERCOUNTER_CLOSEBUTTON = '#quests:missions/filterCounter/closeButton'
    MISSIONS_FILTER_FILTERBUTTON = '#quests:missions/filter/filterButton'
    ...
    ACTION_SHORT_MUL_EQUIPMENTPRICEALL = '#quests:action/short/mul_EquipmentPriceAll'
    ACTION_BUTTON_MUL_EQUIPMENTPRICEALL = '#quests:action/button/mul_EquipmentPriceAll'
    ...
    ACTION_FULL_MUL_SHELLPRICEALL = '#quests:action/full/mul_ShellPriceAll'
    ACTION_SHORT_MUL_SHELLPRICEALL = '#quests:action/short/mul_ShellPriceAll'
    ACTION_BUTTON_MUL_SHELLPRICEALL = '#quests:action/button/mul_ShellPriceAll'
    ...
    ACTION_ENUM = (ACTION_AUTO_EXCHANGERATE,
     ...
     ACTION_SHORT_MUL_EQUIPMENTPRICEALL,
     ACTION_BUTTON_MUL_EQUIPMENTPRICEALL,
     ...
     ACTION_FULL_MUL_SHELLPRICEALL,
     ACTION_SHORT_MUL_SHELLPRICEALL,
     ACTION_BUTTON_MUL_SHELLPRICEALL,
