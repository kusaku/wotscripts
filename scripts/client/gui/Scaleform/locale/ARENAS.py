...
class ARENAS(object):
    ...
    TYPE_EVENT_NAME = '#arenas:type/event/name'
    TYPE_EVENT_DESCRIPTION = '#arenas:type/event/description'
    ...
    C_119_MOON_POOL_NAME = '#arenas:119_moon_pool/name'
    C_119_MOON_POOL_DESCRIPTION = '#arenas:119_moon_pool/description'