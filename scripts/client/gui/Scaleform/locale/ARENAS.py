...
class ARENAS(object):
    ...
    TYPE_LEVIATHAN_DESCRIPTION = '#arenas:type/leviathan/description'
    ...
    C_120_KHARKIV_HALLOWEEN_NAME = '#arenas:120_kharkiv_halloween/name'
    C_120_KHARKIV_HALLOWEEN_DESCRIPTION = '#arenas:120_kharkiv_halloween/description'
