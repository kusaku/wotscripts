...
class FORTIFICATIONS(object):
    ...
    SORTIE_INTROVIEW_FORTBATTLES_NOBATTLESTODAY = '#fortifications:sortie/introView/fortBattles/noBattlesToday'
    ...
    ROSTERINTROWINDOW_INTROVIEW_FORTBATTLES_NEXTTIMEOFBATTLETODAY = '#fortifications:rosterIntroWindow/introView/fortBattles/nextTimeOfBattleToday'
    ROSTERINTROWINDOW_INTROVIEW_FORTBATTLES_NEXTTIMEOFBATTLETOMORROW = '#fortifications:rosterIntroWindow/introView/fortBattles/nextTimeOfBattleTomorrow'
    ...
    ROSTERINTROWINDOW_INTROVIEW_FORTBATTLES_NOBATTLESTODAY = '#fortifications:rosterIntroWindow/introView/fortBattles/noBattlesToday'
    ...
    FORT2MAP_RANDOMMAP = '#fortifications:fort2map/randomMap'
    FORT2BUILDS_POINT1 = '#fortifications:fort2builds/point1'
    FORT2BUILDS_POINT2 = '#fortifications:fort2builds/point2'
    FORT2BUILDS_POINT3 = '#fortifications:fort2builds/point3'
    FORT2BUILDS_POINT4 = '#fortifications:fort2builds/point4'
    FORT2BUILDS_POINT5 = '#fortifications:fort2builds/point5'
    FORT2BUILDS_POINT6 = '#fortifications:fort2builds/point6'
    FORT2BUILDS_DIRECTION = '#fortifications:fort2builds/direction'
    FORT2BUILDS_DIRECTIONENEMY = '#fortifications:fort2builds/directionEnemy'
    FORT2BUILDS_REWARDPOINT1 = '#fortifications:fort2builds/rewardPoint1'
    FORT2BUILDS_REWARDPOINT2 = '#fortifications:fort2builds/rewardPoint2'
    FORT2BUILDS_REWARDPOINT3 = '#fortifications:fort2builds/rewardPoint3'
    FORT2BUILDS_REWARDPOINT4 = '#fortifications:fort2builds/rewardPoint4'
    FORT2BUILDS_REWARDPOINT5 = '#fortifications:fort2builds/rewardPoint5'
    FORT2BUILDS_REWARDPOINT6 = '#fortifications:fort2builds/rewardPoint6'
    FORT2BUILDS_REWARDFIRSTTIME = '#fortifications:fort2builds/rewardFirstTime'
    FORT2BUILDS_REWARDREQUISITION = '#fortifications:fort2builds/rewardRequisition'
    FORT2BUILDS_MAPNAME = '#fortifications:fort2builds/mapName'
    FORT2BUILDS_MAPUNKNOWN = '#fortifications:fort2builds/mapUnknown'
    FORT2BUILDS_TOTALDESCRIPTION = '#fortifications:fort2builds/totalDescription'
    FORT2BUILDS_DIRECTION_A = '#fortifications:fort2builds/direction/A'
    FORT2BUILDS_DIRECTION_B = '#fortifications:fort2builds/direction/B'
    FORT2BUILDS_DIRECTION_C = '#fortifications:fort2builds/direction/C'
    FORT2BUILDS_DIRECTION_D = '#fortifications:fort2builds/direction/D'
    FORT2BUTTONS_MAKEVISIBLE = '#fortifications:fort2buttons/makeVisible'
    FORT2BUTTONS_MAKEINVISIBLE = '#fortifications:fort2buttons/makeInvisible'
    FORT2BUTTONS_MAKEVISIBLESTATUS = '#fortifications:fort2buttons/makeVisibleStatus'
    FORT2BUTTONS_MAKEINVISIBLESTATUS = '#fortifications:fort2buttons/makeInvisibleStatus'
    FORT2TOOLTIPS_SORTIETITLE = '#fortifications:fort2tooltips/sortieTitle'
    FORT2TOOLTIPS_FORTTITLE = '#fortifications:fort2tooltips/fortTitle'
    FORT2TOOLTIPS_CROSSSWORDS = '#fortifications:fort2tooltips/crossSwords'
    FORT2TOOLTIPS_MINUTS = '#fortifications:fort2tooltips/minuts'
    FORT2TOOLTIPS_HOURS = '#fortifications:fort2tooltips/hours'
    FORT2TABLE_ROSTER = '#fortifications:fort2table/roster'
    FORT2TABLE_RATING = '#fortifications:fort2table/rating'
    FORT2TABLE_TECH = '#fortifications:fort2table/tech'
    FORT2RESERVE_TOOLTIP_WITHPERMITION = '#fortifications:fort2reserve/tooltip/withPermition'
    FORT2RESERVE_TOOLTIP_WITHOUTPERMITION = '#fortifications:fort2reserve/tooltip/withoutPermition'
    FORT2RESERVE_TOOLTIP_EMPTY = '#fortifications:fort2reserve/tooltip/empty'
    FORT2RESERVE_TOOLTIP_DISABLEDREQUISITION = '#fortifications:fort2reserve/tooltip/disabledRequisition'
    FORT2RESERVE_TOOLTIP_DISABLEDINBATTLE = '#fortifications:fort2reserve/tooltip/disabledInBattle'
    FORT2RESERVE_TOOLTIP_LEVEL = '#fortifications:fort2reserve/tooltip/level'
    FORT2RESERVE_TOOLTIP_INSTORAGE = '#fortifications:fort2reserve/tooltip/inStorage'
    FORT2RESERVE_TOOLTIP_READYTOSELECT = '#fortifications:fort2reserve/tooltip/readyToSelect'
    FORT2RESERVE_TOOLTIP_SELECTED = '#fortifications:fort2reserve/tooltip/selected'
    FORT2RESERVE_TOOLTIP_CONDITION = '#fortifications:fort2reserve/tooltip/condition'
    FORT2RESERVE_TOOLTIP_CONDITIONREQUISITION = '#fortifications:fort2reserve/tooltip/conditionRequisition'
    FORT2RESERVE_TOOLTIP_SUPPORTACTIVATION = '#fortifications:fort2reserve/tooltip/supportActivation'
    FORT2RESERVE_TOOLTIP_HEAVYTRUCKSACTIVATION = '#fortifications:fort2reserve/tooltip/heavytrucksActivation'
    FORT2RESERVE_TOOLTIP_REQUISITIONACTIVATION = '#fortifications:fort2reserve/tooltip/requisitionActivation'
    FORT2TITLE_SORTIE = '#fortifications:fort2title/sortie'
    FORT2TITLE_STRONGHOLD = '#fortifications:fort2title/stronghold'
    FORT2_TEAMHEADER = '#fortifications:fort2/teamHeader'
    FORT2INFO_SORTIE = '#fortifications:fort2info/sortie'
    FORT2INFO_STRONGHOLD = '#fortifications:fort2info/stronghold'
    FORT2RESERVE_REQUISITION = '#fortifications:fort2reserve/requisition'
    FORT2RESERVE_HEAVYTRUCKS = '#fortifications:fort2reserve/heavyTrucks'
    FORT2RESERVE_SUPPORT = '#fortifications:fort2reserve/support'
    FORT2DIRECTION_A = '#fortifications:fort2direction/A'
    FORT2DIRECTION_B = '#fortifications:fort2direction/B'
    FORT2DIRECTION_C = '#fortifications:fort2direction/C'
    FORT2DIRECTION_D = '#fortifications:fort2direction/D'
