...
class BATTLE_RESULTS(object):
    ...
    TEAM_FOOTBALLGOALS = '#battle_results:team/footballGoals'
    TEAM_FOOTBALLASSISTS = '#battle_results:team/footballAssists'
    ...
    FINISH_FOOTBALL_REASON_WIN = '#battle_results:finish/football_reason/win'
    FINISH_FOOTBALL_REASON_LOSE = '#battle_results:finish/football_reason/lose'
    ...
    TEAM_FOOTBALLGOALS_HEADER = TEAM_FOOTBALLGOALS + '/header'
    TEAM_FOOTBALLGOALS_BODY = TEAM_FOOTBALLGOALS + '/body'
    TEAM_FOOTBALLASSISTS_HEADER = TEAM_FOOTBALLASSISTS + '/header'
    TEAM_FOOTBALLASSISTS_BODY = TEAM_FOOTBALLASSISTS + '/body'
    ...
    FOOTBALL_RETENTIONONALLYSIDE = '#battle_results:football/retentionOnAllySide'
    FOOTBALL_RETENTIONONENEMYSIDE = '#battle_results:football/retentionOnEnemySide'
