...
class INGAME_GUI(object):
    ...
    TIMER_FOOTBALL_STARTING = '#ingame_gui:timer/football/starting'
    TIMER_FOOTBALL_STARTED = '#ingame_gui:timer/football/started'
    STATISTICS_FOOTBALL_TITLE = '#ingame_gui:statistics/football/title'
    STATISTICS_FOOTBALL_DESCR = '#ingame_gui:statistics/football/descr'
    STATISTICS_FOOTBALL_COMMONSTATS = '#ingame_gui:statistics/football/commonStats'
    STATISTICS_FOOTBALL_GOALS = '#ingame_gui:statistics/football/goals'
    STATISTICS_FOOTBALL_BALLPOSSESSION = '#ingame_gui:statistics/football/ballPossession'
    STATISTICS_FOOTBALL_EVENTSTIMELINE = '#ingame_gui:statistics/football/eventsTimeline'
    MESSAGES_FOOTBALL_GOALALLY = '#ingame_gui:messages/football/goalAlly'
    MESSAGES_FOOTBALL_GOALENEMY = '#ingame_gui:messages/football/goalEnemy'
    MESSAGES_FOOTBALL_GOALSELF = '#ingame_gui:messages/football/goalSelf'
    MESSAGES_FOOTBALL_OVERTIME_HEADER = '#ingame_gui:messages/football/overtime/header'
    MESSAGES_FOOTBALL_OVERTIME_HEADERDESCR = '#ingame_gui:messages/football/overtime/headerDescr'
    MESSAGES_FOOTBALL_OVERTIME_OR = '#ingame_gui:messages/football/overtime/or'
    MESSAGES_FOOTBALL_OVERTIME_CONDA = '#ingame_gui:messages/football/overtime/condA'
    MESSAGES_FOOTBALL_OVERTIME_CONDB = '#ingame_gui:messages/football/overtime/condB'
    MESSAGES_FOOTBALL_OVERTIME_TIMERDESCR = '#ingame_gui:messages/football/overtime/timerDescr'
    MESSAGES_FOOTBALL_OVERTIME_RAGEBARHEADER = '#ingame_gui:messages/football/overtime/rageBarHeader'
    MESSAGES_FOOTBALL_OVERTIME_RAGEBARWINONPOINTS = '#ingame_gui:messages/football/overtime/rageBarWinOnPoints'
    MESSAGES_FOOTBALL_OVERTIME_RAGEBARENEMYWINONPOINTS = '#ingame_gui:messages/football/overtime/rageBarEnemyWinOnPoints'
