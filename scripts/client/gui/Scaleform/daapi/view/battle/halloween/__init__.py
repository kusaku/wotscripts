# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/halloween/__init__.py
"""
...
def getViewSettings():
    ...
    from gui.Scaleform.daapi.view.battle.halloween import page
    return (ViewSettings(VIEW_ALIAS.HALLOWEEN_PVP_BATTLE_PAGE, page.HalloweenBattlePage, 'battlePage.swf', ViewTypes.DEFAULT, None, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (BattlePageBusinessHandler(VIEW_ALIAS.HALLOWEEN_PVP_BATTLE_PAGE),)
...
class _EventBattlePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = ((VIEW_ALIAS.HALLOWEEN_PVP_BATTLE_PAGE, self.loadViewBySharedEvent),)
