...
class MainView(CustomizationMainViewMeta):
    ...
    def getItemInventoryCount(self, item):
        ...
        return getStyleInventoryCount(item, self.getStyleInfo())
    ...
    def __getAnchorPositionData(self, slotId, region):
        ...
        if anchorPos is None or anchorNorm is None:
            return
        else:
            return AnchorPositionData(cameras.get2DAngleFromCamera(anchorNorm), cameras.projectPoint(anchorPos), slotId)
