...
def getViewSettings():
    ...
    return (GroupedViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_CALENDAR_POPOVER, RankedBattlesCalendarPopover, RANKEDBATTLES_ALIASES.RANKED_BATTLES_CALENDAR_POPOVER_UI, ViewTypes.WINDOW, RANKEDBATTLES_ALIASES.RANKED_BATTLES_CALENDAR_POPOVER, RANKEDBATTLES_ALIASES.RANKED_BATTLES_CALENDAR_POPOVER, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_BATTLE_RESULTS, RankedBattlesBattleResults, RANKEDBATTLES_ALIASES.RANKED_BATTLES_BATTLE_RESULTS_UI, ViewTypes.OVERLAY, RANKEDBATTLES_ALIASES.RANKED_BATTLES_BATTLE_RESULTS, ScopeTemplates.OVERLAY_SCOPE, True),
     ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_AWARD, RankedBattlesAwardsView, RANKEDBATTLES_ALIASES.RANKED_BATTLES_AWARD_UI, ViewTypes.OVERLAY, RANKEDBATTLES_ALIASES.RANKED_BATTLES_AWARD, ScopeTemplates.OVERLAY_SCOPE, True),
     ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_SEASON_COMPLETE, RankedBattlesSeasonCompleteView, RANKEDBATTLES_ALIASES.RANKED_BATTLES_SEASON_COMPLETE_UI, ViewTypes.OVERLAY, RANKEDBATTLES_ALIASES.RANKED_BATTLES_SEASON_COMPLETE, ScopeTemplates.OVERLAY_SCOPE, True),
     ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_STAGE_COMPLETE, RankedBattlesStageCompleteView, RANKEDBATTLES_ALIASES.RANKED_BATTLES_STAGE_COMPLETE_UI, ViewTypes.OVERLAY, RANKEDBATTLES_ALIASES.RANKED_BATTLES_STAGE_COMPLETE, ScopeTemplates.OVERLAY_SCOPE, True),
