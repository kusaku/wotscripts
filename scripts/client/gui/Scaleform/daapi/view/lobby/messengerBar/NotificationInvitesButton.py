...
class NotificationInvitesButton(NotificationInvitesButtonMeta, AppRef):
    ...
    def __getWindow(self):
        return self.app.containerManager.getView(ViewTypes.WINDOW, criteria={POP_UP_CRITERIA.VIEW_ALIAS: g_entitiesFactories.getAliasByEvent(events.ShowWindowEvent.SHOW_NOTIFICATION_INVITES_WINDOW)})