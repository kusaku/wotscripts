...
class _DetailedPersonalMissionInfo(_MissionInfo):
    ...
    def _getUnavailableStatusFields(self, errorMsg):
        ...
        if errorMsg == 'noVehicle':
            return self.__getNoVehicleStatusFields()
        return self.__getUnlockedStatusFields()
    ...
    def __getRetryBtnTooltip(self):
        if self.event.areTokensPawned():
            return PERSONAL_MISSIONS.DETAILEDVIEW_TOOLTIPS_RETURNAWARDLISTBTN
        return PERSONAL_MISSIONS.DETAILEDVIEW_TOOLTIPS_RETRYBTN
