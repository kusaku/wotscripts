...
class BINDING_ID(object):
    ...
    STRATEGIC_CAMERA = 11
    CLIENT_SUB_GUN_MARKER_DATA_PROVIDER = 12
    SUB_GUN_MARKER_STATE = 13
    RANGE = (CTRL_MODE_NAME,
     ...
     STRATEGIC_CAMERA,
     CLIENT_SUB_GUN_MARKER_DATA_PROVIDER,
     SUB_GUN_MARKER_STATE)
...
_DEFAULT_VALUES = {BINDING_ID.CTRL_MODE_NAME: lambda : _Observable(CTRL_MODE_NAME.DEFAULT),
 ...
 BINDING_ID.SUB_GUN_MARKER_STATE: lambda : _Observable((Math.Vector3(0.0, 0.0, 0.0), 0.0, None)),
 ...
 BINDING_ID.CLIENT_SUB_GUN_MARKER_DATA_PROVIDER: lambda : _Observable(None)}
