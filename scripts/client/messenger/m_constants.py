...
class SCH_CLIENT_MSG_TYPE(object):
    SYS_MSG_TYPE, PREMIUM_ACCOUNT_EXPIRY_MSG, AOGAS_NOTIFY_TYPE, ACTION_NOTIFY_TYPE, BATTLE_TUTORIAL_RESULTS_TYPE, KOREA_PARENTAL_CONTROL_TYPE, NY_EVENT_STARTED, NY_EVENT_FINISHED, NY_TANKMAN_RECRUITED, NY_PRESENT_BOX_RECEIVED, NY_SETTING_COLLECTED = range(11)