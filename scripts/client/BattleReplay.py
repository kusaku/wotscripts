...
class BattleReplay():
    ...
    def getGunMarkerPos(self, turretIndex):
        ...
        return self.__replayCtrl.secondaryGunMarkerPosition
    ...
    def getArcadeGunMarkerSize(self, turretIndex):
        ...
        return self.__replayCtrl.getSecondaryArcadeGunMarkerSize()
    ...
    def getTurretYaw(self, turretIndex):
        ...
        return self.__replayCtrl.secondaryTurretYaw
    ...
    def getGunPitch(self, turretIndex):
        ...
        return self.__replayCtrl.secondaryGunPitch

    def getGunReloadAmountLeft(self, turretIndex):
        if turretIndex == 0:
            return self.__replayCtrl.getGunReloadAmountLeft()
        return self.__replayCtrl.getSecondaryGunReloadAmountLeft()
