# Embedded file name: scripts/client/helpers/xmltodict.py
...
def unparse(input_dict, output = None, encoding = 'utf-8', full_document = True, short_empty_elements = False, xml_generator_cls = None, **kwargs):
    ...
    '` and indented with `' '`, but this
        ...
        The 'xml_generator_cls' parameter allows to use custom xml-generator
        instead of xml.sax.saxutils.XMLGenerator.
        """
