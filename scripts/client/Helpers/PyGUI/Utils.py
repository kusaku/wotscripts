...
def createTextWithBackground(text, font, bgcolour, fgcolour = (255, 255, 255, 255)):
    w = GUI.Window(db.DBLogic.g_instance.getGUITexture('TX_MAP_MASK'))
    w.colour = bgcolour
    w.materialFX = 'BLEND'
    w.widthMode = 'PIXEL'
    w.heightMode = 'PIXEL'
...
class BlinkingCursor(PyGUIBase):
    ...
    @staticmethod
    def create():
        component = GUI.Simple(db.DBLogic.g_instance.getGUITexture('TX_MAP_MASK'))
