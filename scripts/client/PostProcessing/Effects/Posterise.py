...
def buildMeanVariancePhase(input, output):
    p = buildPhase(input, output, 'shaders/post_processing/kuwahara_mean_variance.fx', straightTransfer4Tap, BW_BLEND_ONE, BW_BLEND_ZERO)
...
def buildVarianceSelectPhase(input, output):
    p = buildPhase(input, output, 'shaders/post_processing/kuwahara_variance_select.fx', straightTransfer4Tap, BW_BLEND_ONE, BW_BLEND_ZERO)
