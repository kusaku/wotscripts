...
def filmGrain():
    ...
    fg = buildFilmGrainPhase(textures, punchcard, None, 'shaders/post_processing/film_grain.fx', straightTransfer4Tap, BW_BLEND_SRCALPHA, BW_BLEND_INVSRCALPHA)
    textures = []
    for i in xrange(2, 4):
        textures.append('%sscratch_0%s.tga' % (base, str(i + 1)))
    ...
    punchcard = base + 'oldfilm_punchcard.bmp'
    fg2 = buildFilmGrainPhase(textures, punchcard, None, 'shaders/post_processing/film_grain.fx', straightTransfer4Tap, BW_BLEND_SRCALPHA, BW_BLEND_INVSRCALPHA)
